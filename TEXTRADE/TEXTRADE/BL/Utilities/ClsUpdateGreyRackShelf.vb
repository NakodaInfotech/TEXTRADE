...
Public Class ClsUpdateGreyRackShelf
...
#Region "Functions"
        ...
        Public Function SAVE() As DataTable
            ...
            Try
            'save purchase order
            Dim strCommand As String = "SP_UTILITIES_UPDATEGREYRACKSHELF_SAVE"
        ...
        Public Function UPDATE() As Integer
            ...
            Dim strCommand As String = "SP_UTILITIES_UPDATEGREYRACKSHELF_UPDATE"
            Dim alParameter As New ArrayList
                With alParameter
        ...
        Public Function SELECTUPDATERACKSHELF(ByVal RECONO As Integer, ByVal YearID As Integer) As DataTable
            ...
            Dim strCommand As String = "SP_SELECTUPDATEGREYRACKSHELF_FOR_EDIT"
            Dim alParameter As New ArrayList
                With alParameter
        ...
        Public Function DELETE() As Integer
            Dim intResult As Integer
            Try
            Dim strCommand As String = "SP_UTILITIES_UPDATEGREYRACKSHELF_DELETE"
            Dim alParameter As New ArrayList
                With alParameter
