...
Public Class ClsAgencyOpeningBills
...
#Region "Functions"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            'save OPENING BILLS
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYOPENINGBILLS_SAVE"
    ...
    Public Function UPLOAD() As Integer
        ...
        Try
            'save OPENING BILLS
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYOPENINGBILLS_UPLOAD"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function OPENINGSAVE() As Integer
        ...
        Try
            'save OPENING BILLS
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYOPENINGBALANCE_SAVE"
            Dim alParameter As New ArrayList
            With alParameter
