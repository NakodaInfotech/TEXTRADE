...
Public Class ClsAgencyInvoiceMaster
...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYINVOICEMASTER_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@GRIDTRANS", alParaval(I)))
                I = I + 1
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@CHANGEADD", alParaval(I)))
                I += 1
                ...
                .Add(New SqlClient.SqlParameter("@SALETYPE", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@SACCODE", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@MATERIALVALUE", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@TOTALWITHMATVALUE", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@COSTCENTERNAME", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@REFERREDBY", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TRADINGACC", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@COMM", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@COMMTYPE", alParaval(I)))
                I = I + 1


                'ORDER GRID parameters
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYINVOICEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectINVOICE(ByVal INVNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_AGENCY_SELECTINVOICE_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYINVOICEMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INVNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@CHKBARCODE", alParaval(1)))
    ...
    Public Function SAVEQRCODE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYINVOICEMASTER_QRCODE"
            Dim alParameter As New ArrayList
            With alParameter
