...
Public Class ClsAgencySaleReturn
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save Sale Return
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYSALERETURN_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYSALERETURN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTSALRET(ByVal SALRETNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTAGENCYSALERETURN_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEQRCODE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_AGENCY_SALE_AGENCYSALERETURN_QRCODE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYSALERETURN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
