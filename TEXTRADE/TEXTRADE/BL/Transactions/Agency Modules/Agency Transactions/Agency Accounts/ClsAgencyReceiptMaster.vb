...
Public Class ClsAgencyReceiptMaster
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save PAYMENT MASTER
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYRECEIPTMASTER_SAVE"
    ...
    Public Function selectbill_edit(ByVal BILLno As Integer, ByVal REGISTERNAME As String, ByVal CMPID As Integer, ByVal LOCATIONID As Integer, ByVal YEARID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYRECEIPTMASTER_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYRECEIPTMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETBILLS(ByVal CMPID As Integer, ByVal NAME As String, ByVal YEARID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYRECEIPTMASTER_GETBILLS"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As DataTable
        Dim dtTable As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_AGENCY_AGENCYRECEIPTMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
