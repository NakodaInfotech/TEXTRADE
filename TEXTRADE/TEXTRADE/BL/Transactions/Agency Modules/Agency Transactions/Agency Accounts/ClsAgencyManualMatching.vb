...
Public Class ClsAgencyManualMatching
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save PAYMENT MASTER
            Dim strCommand As String = "SP_TRANS_AGENCYMANUALMATCHING_SAVE"
    ...
    Public Function SELECTBILL(ByVal MATCHNO As Integer, ByVal YEARID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_AGENCYMANUALMATCHING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_AGENCYMANUALMATCHING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETBILLS(ByVal NAME As String, ByVal YEARID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_AGENCYMATCHING_GETBILLS"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As DataTable
        Dim dtTable As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_AGENCYMANUALMATCHING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
