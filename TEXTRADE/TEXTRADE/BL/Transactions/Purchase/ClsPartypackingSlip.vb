Imports DB
Public Class ClsPARTYPACKINGSLIP
...
#Region "Functions"
    ...
    Public Function save() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_MFG_PARTYPACKINGSLIP_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_MFG_PARTYPACKINGSLIP_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@ppsno", alParaval(I)))
                I = I + 1
            End With
            intResult = objDBOperation.executeNonQuery(strCommand, alParameter)
    ...
    Public Function selectPARTYPACKINGSLIP(ByVal PO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTPARTYPACKINGSLIP_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@ppsno", PO))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_MFG_PARTYPACKINGSLIP_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@ppsno", alParaval(0)))
