    ...
    Public Function SAVE() As DataTable
        Try
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALCHECKEDPCS", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALRECDWT", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALWT", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALWTDIFF", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@CHKWIDTH", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@RECDWT", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@WT", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@WTDIFF", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@DECLMTRS", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@DECLPCS", alParaval(I)))
                I = I + 1
            End With
