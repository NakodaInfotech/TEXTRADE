...
Public Class ClsStoreConsumption
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_STORES_STORECONSUME_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_STORES_STORECONSUME_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTCONSUME() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTSTORESCONSUME_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_STORES_STORECONSUME_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@CONSUMENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
