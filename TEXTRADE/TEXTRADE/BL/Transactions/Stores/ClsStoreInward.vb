...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_STORES_STOREINWARD_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@ORDERINWARDQTY", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_STORES_STOREINWARD_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTINWARD() As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTSTORESINWARD_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INWARDNO", alParaval(0)))
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_STORES_STOREINWARD_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INWARDNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
