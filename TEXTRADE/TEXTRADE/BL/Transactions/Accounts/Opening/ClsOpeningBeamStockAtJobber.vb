...
Public Class ClsOpeningBeamStockAtJobber
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_OPENINGBEAMSTOCKATJOBBER_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_OPENINGBEAMSTOCKATJOBBER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectBEAMISSUE() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTOPENINGBEAMSTOCKATJOBBER_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_OPENINGBEAMSTOCKATJOBBER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BEAMISSUENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
    ...
    Public Function SAVEUPLOAD() As Integer
        Dim INTRESULT As Integer
        Try
            Dim STRCOMMAND As String = "SP_TRANS_OPENINGBEAMSTOCKATJOBBER_SAVEUPLOAD"
