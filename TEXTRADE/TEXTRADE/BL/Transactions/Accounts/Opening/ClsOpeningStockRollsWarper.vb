...
Public Class ClsOpeningStockRollsWarper
...
#Region "Function"
    ...
    Public Function SAVE() As DataTable
        Try
            Dim strcommand As String = "SP_MASTER_STOCKMASTERROLLSWARPER_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            strcommand = "SP_MASTER_STOCKMASTERROLLSWARPER_UPDATE"
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@OPROLLSTOCKNOWARPER", alParaval(I)))
                I += 1
            End With
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            ...
            'save CategoryMaster
            strcommand = "SP_MASTER_STOCKMASTERROLLSWARPER_DELETE"
    ...
    Public Function GETSTOCKROLLS() As DataTable
        Dim dtTable As DataTable
        Dim strcommand As String = ""
        Try
            strcommand = "SP_SELECTOPENINGSTOCK_ROLLSWARPER_FOR_EDIT"

            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@OPROLLSTOCKNOWARPER", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YEARID", alParaval(1)))
            End With
            dtTable = objDBOperation.execute(strcommand, alParameter).Tables(0)
