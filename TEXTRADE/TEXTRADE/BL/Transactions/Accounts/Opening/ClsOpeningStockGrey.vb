...
Public Class ClsOpeningStockGrey
...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERGREY_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERGREY_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERGREY_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
