...
#Region "Functions"
    ...
    Public Function GETALL() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_TCSCHALLAN_GETALL"
    ...
    Public Function GETUNPAID() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_TRANS_TCSCHALLAN_GETUNPAID"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@fromdate", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@todate", alParaval(1)))
    ...
    Public Function SAVE() As Integer
        ...
        Try
            'save TRIALBALANCE
            Dim strCommand As String = "SP_TRANS_TCSCHALLAN_SAVE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@REGISTERID", alParaval(I)))
                I += 1
