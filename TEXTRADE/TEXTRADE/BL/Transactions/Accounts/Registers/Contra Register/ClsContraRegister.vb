...
Public Class ClsContraRegister
...
#Region "Functions"
    ...
    Public Function getdata() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CONTRAREGISTER"
    ...
    Public Function getSUMMARY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CONTRA_SUMMARY"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function getDETAILS() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CONTRA_DETAILS"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETDAILY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CONTRA_DAILY"
            Dim alParameter As New ArrayList
            With alParameter
