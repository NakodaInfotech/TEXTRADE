...
#Region "Functions"
    ...
    Public Function getdata() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_PURCHASEREGISTER"
    ...
    Public Function getSUMMARY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_PURCHASE_SUMMARY"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function getDETAILS() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_PURCHASE_DETAILS"
            Dim alParameter As New ArrayList
            With alParameter
