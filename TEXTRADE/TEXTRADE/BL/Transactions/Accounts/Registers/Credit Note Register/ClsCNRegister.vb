...
#Region "Functions"
    ...
    Public Function getdata() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CREDITNOTEREGISTER"
    ...
    Public Function getSUMMARY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CREDITNOTE_SUMMARY"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function getDETAILS() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CREDITNOTE_DETAILS"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETDAILY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_CREDITNOTE_DAILY"
            Dim alParameter As New ArrayList
            With alParameter
