...
#Region "Functions"
    ...
    Public Function getdata() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_SALEREGISTER"
    ...
    Public Function getSUMMARY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_SALE_SUMMARY"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function getDETAILS() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_SALE_DETAILS"
            Dim alParameter As New ArrayList
            With alParameter
