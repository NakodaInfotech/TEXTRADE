...
Public Class ClsExpenseRegister
...
#Region "Functions"
    ...
    Public Function GETDATA() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_EXPENSEREGISTER"
    ...
    Public Function GETSUMMARY() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_EXPENSE_SUMMARY"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETDETAILS() As DataTable
        ...
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_EXPENSE_DETAILS"
            Dim alParameter As New ArrayList
            With alParameter
