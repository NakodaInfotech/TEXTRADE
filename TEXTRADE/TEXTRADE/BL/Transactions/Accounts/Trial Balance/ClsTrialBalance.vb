...
#Region "Functions"
    ...
    End Function
    Public Function SAVESALEANALYSIS() As Integer
        Dim intResult As Integer
        Try
            'save TRIALBALANCE
            Dim strCommand As String = "SP_TRANS_GRIDSALEANALYSIS_SAVE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@FEBRUARY", alParaval(I)))
                I += 1
    ...
    Public Function SAVEPURANALYSIS() As Integer
        Dim intResult As Integer
        Try
            'save TRIALBALANCE
            Dim strCommand As String = "SP_TRANS_GRIDPURANALYSIS_SAVE"
            Dim alParameter As New ArrayList
            With alParameter
