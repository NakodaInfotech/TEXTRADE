...
Public Class ClsRecFromPacking
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_JOB_RECPACKING_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@OUTBARCODE", alParaval(I)))
                I = I + 1

                .Add(New SqlClient.SqlParameter("@ISSUEMTRS", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@PENDINGMTRS", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@ISSUENO", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@ISSUESRNO", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@ISSUETYPE", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_JOB_RECPACKING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    'Public Function SELECTRECPACKING(ByVal RECNO As Integer, ByVal YearID As Integer) As DataTable
    Public Function SELECTRECPACKING() As DataTable

        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTRECPACKING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_JOB_RECPACKING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@RECNO", alParaval(0)))
