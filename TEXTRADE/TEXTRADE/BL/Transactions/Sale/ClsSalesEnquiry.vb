...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_SALE_SALESENQUIRY_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_SALE_SALESENQUIRY_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectSo(ByVal pono As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTENQ_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_SALE_SALESENQUIRY_DELETE"
            Dim alParameter As New ArrayList
            Dim I As Integer = 0
            With alParameter
                .Add(New SqlClient.SqlParameter("@Sono", alParaval(I)))
    ...
    Public Function CLOSESO() As Integer
        ...
        Try
            'CLOSE SALE order
            Dim strCommand As String = "SP_TRANS_SALE_SALESENQUIRY_CLOSESO"
            Dim alParameter As New ArrayList
            Dim I As Integer = 0
            With alParameter
                .Add(New SqlClient.SqlParameter("@SONO", alParaval(I)))
