...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_MFG_PACKINGSLIP_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_MFG_PACKINGSLIP_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectPACKINGSLIP(ByVal PACKINGNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTPACKINGSLIP_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@PACKINGNO", PACKINGNO))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_MFG_PACKINGSLIP_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@PACKINGNO", alParaval(0)))
