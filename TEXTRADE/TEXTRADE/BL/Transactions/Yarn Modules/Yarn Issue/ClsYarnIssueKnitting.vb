...
Public Class ClsYarnIssueKnitting
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNISSUEKNITTING_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNISSUEKNITTING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEUPLOAD() As Integer
        ...
        Try
            ...
            strcommand = "SP_TRANS_YARNISSUEKNITTING_SAVEUPLOAD"
    ...
    Public Function selectYARN(ByVal YARNNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTYARNISSUEKNITTING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNISSUEKNITTING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
