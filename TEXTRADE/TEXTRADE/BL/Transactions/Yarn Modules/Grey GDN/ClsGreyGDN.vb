    ...
    Public Function SAVE() As DataTable
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@GRIDSTORESRNO", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@STOREITEMNAME", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@STOREQTY", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@STOREUNIT", alParaval(I)))
                I = I + 1

                .Add(New SqlClient.SqlParameter("@CONTRACTOR", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@CHKCHANGEADD", alParaval(I)))
                I = I + 1
    ...
    Public Function Delete() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@CLIENTNAME", alParaval(7)))
