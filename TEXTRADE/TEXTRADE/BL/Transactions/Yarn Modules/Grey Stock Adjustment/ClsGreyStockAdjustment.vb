...
Public Class ClsGreyStockAdjustment
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_GREYSTOCKADJUSTMENT_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_GREYSTOCKADJUSTMENT_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTSTOCKADJUSTMENT(ByVal RECONO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTGREYSTOCKADJUSTMENT_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_GREYSTOCKADJUSTMENT_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
