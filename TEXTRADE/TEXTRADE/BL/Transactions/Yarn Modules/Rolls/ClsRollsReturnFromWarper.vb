...
Public Class ClsRollsReturnFromWarper
...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_ROLLSRETURN_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_ROLLSRETURN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@ROLLRETURNNO", alParaval(I)))
                I = I + 1
            End With
    ...
    Public Function selectROLLSRETURN() As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTROLLSRETURN_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@ROLLRETURNNO", alParaval(0)))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_ROLLSRETURN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@ROLLRETURNNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
    ...
    Public Function SAVEUPLOAD() As Integer
        Dim INTRESULT As Integer
        Try
            Dim STRCOMMAND As String = "SP_TRANS_ROLLSRETURN_SAVEUPLOAD"
