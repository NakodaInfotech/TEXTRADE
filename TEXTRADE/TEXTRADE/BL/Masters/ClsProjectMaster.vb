...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save PROJECTMaster
            Dim strCommand As String = "SP_MASTER_PROJECTMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PROJECTname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save PROJECTMaster
            Dim strCommand As String = "SP_MASTER_PROJECTMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("PROJECTid", alParaval(7)))
