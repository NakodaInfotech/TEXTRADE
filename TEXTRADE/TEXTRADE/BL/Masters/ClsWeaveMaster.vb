...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save CategoryMaster
            Dim strCommand As String = "SP_MASTER_WEAVEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@WEAVEname", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@WEAVEremarks", alParaval(1)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save CategoryMaster
            Dim strCommand As String = "SP_MASTER_WEAVEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
