...
Public Class ClsPackingTypeMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save StampMaster
            Dim strCommand As String = "SP_MASTER_PACKINGTYPEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PACKINGTYPE", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save StampMaster
            Dim strCommand As String = "SP_MASTER_PACKINGTYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@PACKINGTYPEid", alParaval(7)))
