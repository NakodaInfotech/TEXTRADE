    ...
    Public Function SAVE() As DataTable
        Try
            ...
            With alParameter
                ...
                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@MANUALPROGNO", alParaval(I)))
                I += 1
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@CARDISSUEDATE", alParaval(I)))
                I += 1
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@FINISHTYPE", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@FOLD", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@KHADI", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@ABOVETOSCREEN", alParaval(I)))
                I += 1
