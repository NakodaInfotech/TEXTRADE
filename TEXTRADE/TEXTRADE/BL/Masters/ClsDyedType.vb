...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_DYEDTYPE_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@DYEDname", alParaval(0)))
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            'save DEPARTMENTMaster
            Dim strCommand As String = "SP_MASTER_DYEDTYPE_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@DYEDTYPEid", alParaval(7)))
