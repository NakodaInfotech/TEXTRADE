...
Public Class ClsPieceTypeMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save PIECETYPEMaster
            Dim strCommand As String = "SP_MASTER_PIECETYPEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PIECETYPEname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save PIECETYPEMaster
            Dim strCommand As String = "SP_MASTER_PIECETYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("PIECETYPEid", alParaval(7)))
