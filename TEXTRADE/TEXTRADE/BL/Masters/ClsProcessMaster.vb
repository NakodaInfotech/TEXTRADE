...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@PROCESSname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save PROCESSMaster
            Dim strCommand As String = "SP_MASTER_PROCESSMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("PROCESSid", alParaval(7)))
    ...
    Public Function DELETE() As Integer
        ...
        Try
            ...
            'save PROCESSMaster
            Dim strCommand As String = "SP_MASTER_PROCESSMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("PROCESSid", alParaval(0)))
