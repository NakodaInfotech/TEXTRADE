...
#Region "GSTR1"
    Public Function GSTGSTR1_EXCEL(ByVal CMPID As Integer, ByVal YEARID As Integer, ByVal FROMDATE As Date, ByVal TODATE As Date, CLIENTNAME As String, Optional ByVal REGNAME As String = "") As Object
        Try
            ...
            Dim WHERECLAUSE As String = ""
            'THIS IS COMMENTED BECAUSE FIRST THER USED TO SINGLE FILES BUT NOW WE SEGRATED THIS INTO SINGLE SHEET SO THIS IS GIVING ERROR
            'If REGNAME <> "" Then WHERECLAUSE = " AND REGISTERMASTER.REGISTER_NAME = '" & REGNAME & "'"
            ...
            Write("Party Name", Range("10"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("CGST Amount", Range("11"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("SGST Amount", Range("12"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("IGST Amount", Range("13"), XlHAlign.xlHAlignCenter, , True, 10)
            ...
            'SALE(URD)
            DT = OBJCMN.Execute_Any_String(" SELECT INVOICEMASTER.INVOICE_PRINTINITIALS AS INVNO, INVOICEMASTER.INVOICE_DATE AS DATE, ISNULL(LEDGERS.ACC_GSTIN, '') AS GSTIN, ISNULL(STATEMASTER.STATE_REMARK, '') AS STATECODE, ISNULL(STATEMASTER.STATE_NAME, '') AS STATE, (CASE WHEN ISNULL(INVOICEMASTER.INVOICE_SCREENTYPE,'LINE GST') = 'LINE GST' THEN ISNULL(INVOICEMASTER.INVOICE_TOTALTAXABLEAMT, 0) ELSE ISNULL(INVOICE_SUBTOTAL,0) END) AS TAXABLEAMT, 0 AS GSTPER, ISNULL(INVOICEMASTER.INVOICE_TOTALWITHGST, 0) AS GRANDTOTAL, ISNULL(LEDGERS.ACC_CMPNAME,'') AS NAME, ISNULL(INVOICEMASTER.INVOICE_TOTALCGSTAMT, 0) AS CGSTAMT, ISNULL(INVOICEMASTER.INVOICE_TOTALSGSTAMT, 0) AS SGSTAMT, ISNULL(INVOICEMASTER.INVOICE_TOTALIGSTAMT, 0) AS IGSTAMT FROM INVOICEMASTER INNER JOIN LEDGERS ON INVOICEMASTER.INVOICE_LEDGERID = LEDGERS.Acc_id LEFT OUTER JOIN STATEMASTER ON STATE_ID = LEDGERS.ACC_STATEID  INNER JOIN REGISTERMASTER ON REGISTER_ID = INVOICE_REGISTERID WHERE  INVOICE_DATE >= '" & Format(FROMDATE.Date, "MM/dd/yyyy") & "' AND INVOICE_DATE <= '" & Format(TODATE.Date, "MM/dd/yyyy") & "' " & WHERECLAUSE & " AND  INVOICE_YEARID = " & YEARID & " AND ISNULL(ACC_GSTIN,'') = '' AND ISNULL(INVOICEMASTER.INVOICE_TOTALWITHGST, 0) > 0 AND INVOICE_TOTALIGSTAMT >= 200000 ORDER BY INVOICEMASTER.INVOICE_DATE, INVOICEMASTER.INVOICE_NO", "", "")
            ...
            For Each DTROW As DataRow In DT.Rows
                ...
                Write(DTROW("NAME"), Range("10"), XlHAlign.xlHAlignLeft, , False, 10)
                Write(Val(DTROW("CGSTAMT")), Range("11"), XlHAlign.xlHAlignRight, , False, 10)
                Write(Val(DTROW("SGSTAMT")), Range("12"), XlHAlign.xlHAlignRight, , False, 10)
                Write(Val(DTROW("IGSTAMT")), Range("13"), XlHAlign.xlHAlignRight, , False, 10)
            Next
            ...
            Write("Party Name", Range("8"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("Invoice No", Range("9"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("CGST Amount", Range("10"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("SGST Amount", Range("11"), XlHAlign.xlHAlignCenter, , True, 10)
            Write("IGST Amount", Range("12"), XlHAlign.xlHAlignCenter, , True, 10)
            ...
            For Each DTROW As DataRow In DT.Rows
                ...
                Write(DTROW("NAME"), Range("8"), XlHAlign.xlHAlignLeft, , False, 10)
                Write(DTROW("INVNO"), Range("9"), XlHAlign.xlHAlignLeft, , False, 10)
                Write(Val(DTROW("CGSTAMT")), Range("10"), XlHAlign.xlHAlignRight, , False, 10)
                Write(Val(DTROW("SGSTAMT")), Range("11"), XlHAlign.xlHAlignRight, , False, 10)
                Write(Val(DTROW("IGSTAMT")), Range("12"), XlHAlign.xlHAlignRight, , False, 10)
            Next
...
#End Region
    ...
    Public Function GSTB2CL_EXCEL(ByVal CMPID As Integer, ByVal YEARID As Integer, ByVal FROMDATE As Date, ByVal TODATE As Date, Optional ByVal REGNAME As String = "") As Object
        Try
            ...
            objSheet.Range(objColumn.Item("11").ToString & 5, objColumn.Item("11").ToString & RowIndex).NumberFormat = "0.00"
            objSheet.Range(objColumn.Item("12").ToString & 5, objColumn.Item("12").ToString & RowIndex).NumberFormat = "0.00"
            objSheet.Range(objColumn.Item("13").ToString & 5, objColumn.Item("13").ToString & RowIndex).NumberFormat = "0.00"
    ...
    Public Function TDSCHALLANDETAILS(ByVal FROMDATE As Date, ByVal TODATE As Date, ByVal CMPID As Integer, ByVal YEARID As Integer) As Object
        Try
            ...
            For Each DTROW As DataRow In DT.Rows
                ...
                Write(Val(DTROW("INTAMT")), Range("3"), XlHAlign.xlHAlignLeft, , True, 10)
                Write("", Range("4"), XlHAlign.xlHAlignLeft, , True, 10)
                Write("", Range("5"), XlHAlign.xlHAlignLeft, , True, 10)
                Write(Val(DTROW("TDSAMT")) + Val(DTROW("INTAMT")), Range("6"), XlHAlign.xlHAlignRight, , True, 10)
