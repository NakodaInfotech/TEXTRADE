        ...
        Try
            ...
            If FRMSTRING = "CREDIT" Then
                ...
                Else
                    ...
                    If ClientName = "ALENCOT" Or ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "CHINTAN" Or ClientName = "ABHEE" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then OBJCRNOTE.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
                End If
            ...
            ElseIf FRMSTRING = "DEBIT" Then
                ...
                Else
                    ...
                    If ClientName = "ALENCOT" Or ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "CHINTAN" Or ClientName = "ABHEE" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then OBJDRNOTE.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
                End If
    ...
    Sub PRINTDIRECTLYTOPRINTER()
        Try
            ...
            If FRMSTRING = "CREDIT" Then
                ...
                If ClientName = "ALENCOT" Or ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "CHINTAN" Or ClientName = "ABHEE" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then OBJ.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
