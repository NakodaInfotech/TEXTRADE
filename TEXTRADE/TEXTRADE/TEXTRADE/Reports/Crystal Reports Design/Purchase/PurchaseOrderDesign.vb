    ...
    Private Sub PurchaseOrderDesign_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If FRMSTRING = "POREPORT" Then
                ...
                End If
            ElseIf FRMSTRING = "STORESPOREPORT" Then
                crTables = RPTSTORESPO.Database.Tables
            ElseIf FRMSTRING = "YARNPOREPORT" Then
        ...
        Try
            ...
            If FRMSTRING = "POREPORT" Then
                ...
                Else
                    ...
                    If PRINTPARTYDESIGN = True Then OBJ.DataDefinition.FormulaFields("PRINTPARTYDESIGN").Text = 1 Else OBJ.DataDefinition.FormulaFields("PRINTPARTYDESIGN").Text = 0
                End If
            ElseIf FRMSTRING = "POPARTYDESIGNREPORT" Then
                OBJ = New POReport
            ElseIf FRMSTRING = "STORESPOREPORT" Then
                OBJ = New StoresPurchaseOrderReport
            ElseIf FRMSTRING = "YARNPOREPORT" Then
        ...
        Try
            ...
            If FRMSTRING = "POREPORT" Then
                If ClientName = "YASHVI" Then
                    ...
                    expo = RPTPO_YASHVI.ExportOptions
                    expo.ExportDestinationType = ExportDestinationType.DiskFile
                    expo.ExportFormatType = ExportFormatType.PortableDocFormat
                    expo.DestinationOptions = oDfDopt
                    RPTPO_YASHVI.Export()
            ...
            ElseIf FRMSTRING = "STORESPOREPORT" Then
                oDfDopt.DiskFileName = Application.StartupPath & "\POREPORT.PDF"
                expo = RPTSTORESPO.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTSTORESPO.Export()
