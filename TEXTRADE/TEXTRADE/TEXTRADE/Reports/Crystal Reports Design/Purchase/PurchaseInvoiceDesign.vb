        ...
        Try
            ...
            If FRMSTRING = "PURRETURN" Then
                ...
                Else
                    ...
                    If ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then RPTPURRETURN.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
                End If
            End If
