...
Public Class PurchaseReturnDesign
    ...
    Dim RPTGODOWNDTLS As New PurchaseReturnGodownWiseDetails
    Dim RPTGODOWNSUMM As New PurchaseReturnGodownWiseSummary
    Dim RPTITEMDTLS As New PurchaseReturnItemWiseDetails
    Dim RPTITEMSUMM As New PurchaseReturnItemWiseSummary
    Dim RPTQUALITYDTLS As New PurchaseReturnQualityWiseDetails
    Dim RPTQUALITYSUMM As New PurchaseReturnQualityWiseSummary
    Dim RPTDESIGNDTLS As New PurchaseReturnDesignWiseDetails
    Dim RPTDESIGNSUMM As New PurchaseReturnDesignWiseSummary
    Dim RPTSHADEDTLS As New PurchaseReturnShadeWiseDetails
    Dim RPTSHADESUMM As New PurchaseReturnShadeWiseSummary
    Dim RPTTRANSDTLS As New PurchaseReturnTransWiseDetails
    Dim RPTTRANSSUMM As New PurchaseReturnTransWiseSummary
    Dim RPTPURRETINDETAILS As New PurchaseReturnInDetailsReport


    Dim RPTDNINDETAILS As New DebitNoteRegisterInDetailsReport
    ...
    Private Sub SaleReturnDesign_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If FRMSTRING = "PURRETREGISTERINDETAIL" Then crTables = RPTPURRETINDETAILS.Database.Tables
            If FRMSTRING = "DNREGISTERINDETAIL" Then crTables = RPTDNINDETAILS.Database.Tables
            ...
            ElseIf FRMSTRING = "PURRETREGISTERINDETAIL" Then
                crpo.ReportSource = RPTPURRETINDETAILS
                RPTPURRETINDETAILS.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
            ElseIf FRMSTRING = "DNREGISTERINDETAIL" Then
                crpo.ReportSource = RPTDNINDETAILS
                RPTDNINDETAILS.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
    ...
    Private Sub sendmailtool_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sendmailtool.Click
        Try
            ...
            Transfer()
            Dim TEMPATTACHMENT As String = "PurchaseRet"
    ...
    Sub Transfer()
        Try
            ...
            oDfDopt.DiskFileName = Application.StartupPath & "\PurchaseRet.pdf"
            ...
            ElseIf FRMSTRING = "MONTHLY" Then
                ...
                RPTMONTHLY.Export()
            ElseIf FRMSTRING = "PURRETREGISTERINDETAIL" Then
                expo = RPTPURRETINDETAILS.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTPURRETINDETAILS.Export()
            ElseIf FRMSTRING = "DNREGISTERINDETAIL" Then
                expo = RPTDNINDETAILS.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTDNINDETAILS.Export()
            End If
    ...
    Sub PRINTDIRECTLYTOPRINTER()
        Try
            ...
            If FRMSTRING = "PURCHASERETURN" Then
                strsearch = "{PURCHASERETURN.PR_no}=" & Val(PURERATE) & " and {PURCHASERETURN.PR_yearid}=" & YearId
            ...
            ElseIf FRMSTRING = "SALERETURNCHALLAN" Then
                strsearch = "{SALERETURNCHALLAN.SRCH_NO}=" & Val(PURERATE) & " and {SALERETURNCHALLAN.SRCH_yearid}=" & YearId
...
SKIPINVOICE:
            ...
            Else
                Dim expo As New ExportOptions
                Dim oDfDopt As New DiskFileDestinationOptions
                oDfDopt.DiskFileName = Application.StartupPath & "\PURERATE_" & PURERATE & ".pdf"
    ...
    Private Sub TOOLWHATSAPP_Click(sender As Object, e As EventArgs) Handles TOOLWHATSAPP.Click
        Try
            ...
            OBJWHATSAPP.PATH.Add(Application.StartupPath & "\PureRet.PDF")
            OBJWHATSAPP.FILENAME.Add("PurRet.pdf")
