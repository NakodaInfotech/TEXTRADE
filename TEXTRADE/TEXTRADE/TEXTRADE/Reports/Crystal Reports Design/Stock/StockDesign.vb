...
Public Class StockDesign
    ...
    Dim RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM As New CategoryItemDesignShadeWithoutUnitSmallSingleStockReport
    Dim RPTBARCODEITEMDESIGNSHADESTOCKSUMM As New BarcodeStockSummReport
    Dim RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM As New BarcodeStockSummSmallReport
...
SKIPINVOICE:
    ...
    Private Sub StockDesign_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If FRMSTRING = "CATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM" Then crTables = RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM.Database.Tables
            If FRMSTRING = "BARCODEITEMDESIGNSHADESTOCKSUMM" Then crTables = RPTBARCODEITEMDESIGNSHADESTOCKSUMM.Database.Tables
            If FRMSTRING = "BARCODEITEMDESIGNSHADESTOCKSMALLSUMM" Then crTables = RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM.Database.Tables
            ...
            ElseIf FRMSTRING = "CATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM" Then
                RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM.DataDefinition.FormulaFields("PERIOD").Text = "' ITEM DESIGN SHADE SMALL STOCK SINGLES SUMMARY - " & PERIOD & "'"
                RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM.DataDefinition.FormulaFields("CLIENTNAME").Text = "'" & ClientName & "'"
                crpo.ReportSource = RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM
            ...
            ElseIf FRMSTRING = "BARCODEITEMDESIGNSHADESTOCKSMALLSUMM" Then
                RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM.DataDefinition.FormulaFields("PERIOD").Text = "' ITEM DESIGN SHADE STOCK SUMMARY - " & PERIOD & "'"
                RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM.DataDefinition.FormulaFields("CLIENTNAME").Text = "'" & ClientName & "'"
                crpo.ReportSource = RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM
    ...
    Sub Transfer()
        Try
            ...
            ElseIf FRMSTRING = "CATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM" Then
                expo = RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTCATEGORYITEMDESIGNSHADESTOCKNOUNITSMALLSINGLESUMM.Export()
            ...
            ElseIf FRMSTRING = "BARCODEITEMDESIGNSHADESTOCKSMALLSUMM" Then
                expo = RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTBARCODEITEMDESIGNSHADESTOCKSMALLSUMM.Export()
