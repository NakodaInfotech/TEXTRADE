        ...
        Try
            ...
            ElseIf FRMSTRING = "SALERETURN" Then
                ...
                Else
                    ...
                    If ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "CHINTAN" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then RPTSALERET.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
                End If
            End If
            crpo.Zoom(100)
            crpo.Refresh()
        ...
        Try
            ...
            If FRMSTRING = "SALERETURN" Then
                ...
                Else
                    ...
                    If ClientName = "VINAYAK" Or ClientName = "SKF" Or ClientName = "MILUXE" Or ClientName = "KENCOT" Or ClientName = "SWPL" Then OBJ.DataDefinition.FormulaFields("SENDMAIL").Text = "1"
                End If
            ElseIf FRMSTRING = "SALERETURNCHALLAN" Then
