...
Public Class WeftIssueDesign
    ...
    Private Sub BeamIssueDesign_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            crpo.ReportSource = RPTWEFTISSUE
            crpo.Zoom(100)
            crpo.Refresh()
    ...
    Private Sub sendmailtool_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sendmailtool.Click
        Try
            ...
            Transfer()
            Dim TEMPATTACHMENT As String = "WEFT ISSUE"
    ...
    Sub Transfer()
        Try
            ...
            oDfDopt.DiskFileName = Application.StartupPath & "\Weft Issue.pdf"

            expo = RPTWEFTISSUE.ExportOptions
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            If Val(TXTCOPIES.Text.Trim) <= 0 Then
                ...
                Exit Sub
            Else
                RPTWEFTISSUE.PrintToPrinter(Val(TXTCOPIES.Text.Trim), True, 0, 0)
            End If
        Catch ex As Exception
            Throw ex
        End Try
