...
Public Class JobInReport_SVS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JobInReport_SVS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobInReport_SVS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobInReport_SVS = New JobInReport_SVS()
        rpt.Site = Me.Site
        Return rpt
    End Function
