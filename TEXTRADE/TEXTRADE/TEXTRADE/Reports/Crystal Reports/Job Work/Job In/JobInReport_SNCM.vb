...
Public Class JobInReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JobInReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobInReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobInReport_SNCM = New JobInReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
