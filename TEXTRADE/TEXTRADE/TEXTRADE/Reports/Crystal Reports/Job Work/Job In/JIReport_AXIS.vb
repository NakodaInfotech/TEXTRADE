...
Public Class JIReport_AXIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JIReport_AXIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJIReport_AXIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JIReport_AXIS = New JIReport_AXIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
