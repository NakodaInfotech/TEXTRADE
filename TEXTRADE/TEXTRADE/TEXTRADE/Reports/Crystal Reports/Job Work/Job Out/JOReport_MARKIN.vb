...
Public Class JOReport_MARKIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_MARKIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_MARKIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_MARKIN = New JOReport_MARKIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
