...
Public Class JOReportCutting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReportCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReportCutting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReportCutting = New JOReportCutting()
        rpt.Site = Me.Site
        Return rpt
    End Function
