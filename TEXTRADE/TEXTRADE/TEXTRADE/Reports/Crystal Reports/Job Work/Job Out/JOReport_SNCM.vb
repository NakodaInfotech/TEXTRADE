...
Public Class JOReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_SNCM = New JOReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
