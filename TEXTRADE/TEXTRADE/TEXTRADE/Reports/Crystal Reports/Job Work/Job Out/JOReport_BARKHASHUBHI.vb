...
Public Class JOReport_BARKHASHUBHI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "JOReport_BARKHASHUBHI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_BARKHASHUBHI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_BARKHASHUBHI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_BARKHASHUBHI = New JOReport_BARKHASHUBHI()
        rpt.Site = Me.Site
        Return rpt
    End Function
