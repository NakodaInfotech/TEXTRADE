...
Public Class JOReport_MOHAN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_MOHAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_MOHAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_MOHAN = New JOReport_MOHAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
