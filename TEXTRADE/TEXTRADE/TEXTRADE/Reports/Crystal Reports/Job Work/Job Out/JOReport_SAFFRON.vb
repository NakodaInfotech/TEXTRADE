...
Public Class JOReport_SAFFRON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_SAFFRON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_SAFFRON = New JOReport_SAFFRON()
        rpt.Site = Me.Site
        Return rpt
    End Function
