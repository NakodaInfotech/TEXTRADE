...
Public Class JobOutReport_SVS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JobOutReport_SVS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobOutReport_SVS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobOutReport_SVS = New JobOutReport_SVS()
        rpt.Site = Me.Site
        Return rpt
    End Function
