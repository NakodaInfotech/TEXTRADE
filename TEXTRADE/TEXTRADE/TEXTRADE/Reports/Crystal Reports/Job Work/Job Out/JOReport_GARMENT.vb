...
Public Class JOReport_GARMENT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_GARMENT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_GARMENT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_GARMENT = New JOReport_GARMENT()
        rpt.Site = Me.Site
        Return rpt
    End Function
