...
Public Class JOReport_KARAN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_KARAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_KARAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_KARAN = New JOReport_KARAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
