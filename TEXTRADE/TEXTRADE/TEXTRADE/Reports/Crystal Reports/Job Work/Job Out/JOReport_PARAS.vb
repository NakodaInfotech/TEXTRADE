...
Public Class JOReport_PARAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_PARAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_PARAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_PARAS = New JOReport_PARAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
