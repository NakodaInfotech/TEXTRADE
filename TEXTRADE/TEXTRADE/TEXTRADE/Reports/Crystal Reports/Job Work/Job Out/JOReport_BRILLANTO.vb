...
Public Class JOReport_BRILLANTO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.JOReport_BRILLANTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_BRILLANTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_BRILLANTO = New JOReport_BRILLANTO()
        rpt.Site = Me.Site
        Return rpt
    End Function
