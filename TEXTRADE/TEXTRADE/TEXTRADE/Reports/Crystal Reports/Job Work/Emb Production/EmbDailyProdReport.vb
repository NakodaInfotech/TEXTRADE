...
Public Class EmbDailyProdReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.EmbDailyProdReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmbDailyProdReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmbDailyProdReport = New EmbDailyProdReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
