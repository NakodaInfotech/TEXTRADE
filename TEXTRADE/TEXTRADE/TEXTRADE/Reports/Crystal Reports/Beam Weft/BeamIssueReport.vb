...
Public Class BeamIssueReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.BeamIssueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBeamIssueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BeamIssueReport = New BeamIssueReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
