...
Public Class MatRecReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.MatRecReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatRecReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatRecReport_SNCM = New MatRecReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
