...
Public Class OpeningReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.OpeningReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOpeningReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OpeningReport_SNCM = New OpeningReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
