...
Public Class AgencyRecReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.AgencyRecReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAgencyRecReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AgencyRecReport = New AgencyRecReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
