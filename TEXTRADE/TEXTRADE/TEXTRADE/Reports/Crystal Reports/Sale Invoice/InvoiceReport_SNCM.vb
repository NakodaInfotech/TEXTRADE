...
Public Class InvoiceReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_SNCM = New InvoiceReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
