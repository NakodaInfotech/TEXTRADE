...
Public Class InvoiceReport_DRDRAPES
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_DRDRAPES.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_DRDRAPES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_DRDRAPES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_DRDRAPES = New InvoiceReport_DRDRAPES()
        rpt.Site = Me.Site
        Return rpt
    End Function
