...
Public Class InvoiceEntryWiseSummReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceEntryWiseSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceEntryWiseSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceEntryWiseSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceEntryWiseSummReport = New InvoiceEntryWiseSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
