...
Public Class InvoiceReport_SIMPLEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_SIMPLEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_SIMPLEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_SIMPLEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_SIMPLEX = New InvoiceReport_SIMPLEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
