...
Public Class InvoiceReport_YARNDO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_YARNDO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_YARNDO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_YARNDO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_YARNDO = New InvoiceReport_YARNDO()
        rpt.Site = Me.Site
        Return rpt
    End Function
