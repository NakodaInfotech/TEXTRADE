...
Public Class InvoiceReport_MAHAVIR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_MAHAVIR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_MAHAVIR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_MAHAVIR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_MAHAVIR = New InvoiceReport_MAHAVIR()
        rpt.Site = Me.Site
        Return rpt
    End Function
