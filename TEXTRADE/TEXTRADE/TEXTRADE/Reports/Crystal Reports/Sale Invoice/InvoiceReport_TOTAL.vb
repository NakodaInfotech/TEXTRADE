...
Public Class InvoiceReport_TOTAL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_TOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_TOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_TOTAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_TOTAL = New InvoiceReport_TOTAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
