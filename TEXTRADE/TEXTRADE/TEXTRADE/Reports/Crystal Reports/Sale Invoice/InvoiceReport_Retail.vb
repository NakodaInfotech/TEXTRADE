...
Public Class InvoiceReport_Retail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_Retail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_Retail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_Retail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_Retail = New InvoiceReport_Retail()
        rpt.Site = Me.Site
        Return rpt
    End Function
