...
Public Class InvoiceReport_SAFFRON
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.InvoiceReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_SAFFRON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_SAFFRON = New InvoiceReport_SAFFRON()
        rpt.Site = Me.Site
        Return rpt
    End Function
