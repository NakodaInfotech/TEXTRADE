...
Public Class CutPackItemReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.CutPackItemReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCutPackItemReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CutPackItemReport = New CutPackItemReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
