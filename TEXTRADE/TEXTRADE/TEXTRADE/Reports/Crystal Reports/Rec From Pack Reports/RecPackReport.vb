...
Public Class RecPackReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.RecPackReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecPackReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecPackReport = New RecPackReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
