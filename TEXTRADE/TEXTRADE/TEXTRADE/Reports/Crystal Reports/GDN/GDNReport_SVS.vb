...
Public Class GDNReport_SVS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SVS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SVS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SVS = New GDNReport_SVS()
        rpt.Site = Me.Site
        Return rpt
    End Function
