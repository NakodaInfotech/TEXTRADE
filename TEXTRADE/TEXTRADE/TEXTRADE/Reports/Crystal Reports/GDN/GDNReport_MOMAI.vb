...
Public Class GDNReport_MOMAI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_MOMAI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_MOMAI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_MOMAI = New GDNReport_MOMAI()
        rpt.Site = Me.Site
        Return rpt
    End Function
