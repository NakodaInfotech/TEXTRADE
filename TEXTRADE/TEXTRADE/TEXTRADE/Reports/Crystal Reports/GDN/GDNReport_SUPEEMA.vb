...
Public Class GDNReport_SUPEEMA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SUPEEMA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SUPEEMA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SUPEEMA = New GDNReport_SUPEEMA()
        rpt.Site = Me.Site
        Return rpt
    End Function
