...
Public Class GDNReport_SNCM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SNCM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SNCM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SNCM = New GDNReport_SNCM()
        rpt.Site = Me.Site
        Return rpt
    End Function
