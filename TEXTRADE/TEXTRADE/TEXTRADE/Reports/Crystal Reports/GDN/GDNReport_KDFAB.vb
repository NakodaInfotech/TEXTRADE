...
Public Class GDNReport_KDFAB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_KDFAB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_KDFAB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_KDFAB = New GDNReport_KDFAB()
        rpt.Site = Me.Site
        Return rpt
    End Function
