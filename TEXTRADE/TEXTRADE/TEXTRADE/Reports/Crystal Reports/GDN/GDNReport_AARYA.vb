...
Public Class GDNReport_AARYA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_AARYA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_AARYA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_AARYA = New GDNReport_AARYA()
        rpt.Site = Me.Site
        Return rpt
    End Function
