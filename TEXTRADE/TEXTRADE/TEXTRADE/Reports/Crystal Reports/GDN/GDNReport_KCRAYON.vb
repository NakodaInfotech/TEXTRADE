...
Public Class GDNReport_KCRAYON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_KCRAYON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_KCRAYON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_KCRAYON = New GDNReport_KCRAYON()
        rpt.Site = Me.Site
        Return rpt
    End Function
