...
Public Class GDNReport_NTC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_NTC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_NTC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_NTC = New GDNReport_NTC()
        rpt.Site = Me.Site
        Return rpt
    End Function
