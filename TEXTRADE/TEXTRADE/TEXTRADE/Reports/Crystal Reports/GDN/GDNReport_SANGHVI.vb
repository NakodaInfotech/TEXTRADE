...
Public Class GDNReport_SANGHVI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SANGHVI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SANGHVI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SANGHVI = New GDNReport_SANGHVI()
        rpt.Site = Me.Site
        Return rpt
    End Function
