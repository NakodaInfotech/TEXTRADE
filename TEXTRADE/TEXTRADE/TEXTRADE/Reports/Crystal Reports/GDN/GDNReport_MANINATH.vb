...
Public Class GDNReport_MANINATH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_MANINATH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_MANINATH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_MANINATH = New GDNReport_MANINATH()
        rpt.Site = Me.Site
        Return rpt
    End Function
