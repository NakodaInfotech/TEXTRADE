...
Public Class GDNReport_SKF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SKF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SKF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SKF = New GDNReport_SKF()
        rpt.Site = Me.Site
        Return rpt
    End Function
