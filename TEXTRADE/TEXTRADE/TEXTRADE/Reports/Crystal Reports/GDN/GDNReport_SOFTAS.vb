...
Public Class GDNReport_SOFTAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SOFTAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SOFTAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SOFTAS = New GDNReport_SOFTAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
