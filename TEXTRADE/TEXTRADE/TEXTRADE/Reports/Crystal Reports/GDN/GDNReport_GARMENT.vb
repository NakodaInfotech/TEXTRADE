...
Public Class GDNReport_GARMENT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_GARMENT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_GARMENT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_GARMENT = New GDNReport_GARMENT()
        rpt.Site = Me.Site
        Return rpt
    End Function
