...
Public Class GDNReport_SBA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SBA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SBA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SBA = New GDNReport_SBA()
        rpt.Site = Me.Site
        Return rpt
    End Function
