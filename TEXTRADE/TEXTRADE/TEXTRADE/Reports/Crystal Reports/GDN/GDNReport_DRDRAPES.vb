...
Public Class GDNReport_DRDRAPES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_DRDRAPES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_DRDRAPES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_DRDRAPES = New GDNReport_DRDRAPES()
        rpt.Site = Me.Site
        Return rpt
    End Function
