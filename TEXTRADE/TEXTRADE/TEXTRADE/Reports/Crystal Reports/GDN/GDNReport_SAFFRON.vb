...
Public Class GDNReport_SAFFRON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SAFFRON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SAFFRON = New GDNReport_SAFFRON()
        rpt.Site = Me.Site
        Return rpt
    End Function
