...
Public Class GDNReport_REALCORP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_REALCORP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_REALCORP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_REALCORP = New GDNReport_REALCORP()
        rpt.Site = Me.Site
        Return rpt
    End Function
