...
Public Class GDNBannerPrintReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GDNBannerPrintReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNBannerPrintReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNBannerPrintReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNBannerPrintReport = New GDNBannerPrintReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
