...
Public Class GDNReport_BALAJI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_BALAJI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_BALAJI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_BALAJI = New GDNReport_BALAJI()
        rpt.Site = Me.Site
        Return rpt
    End Function
