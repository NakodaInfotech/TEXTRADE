...
Public Class GDNReport_SUPRIYA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_SUPRIYA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_SUPRIYA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_SUPRIYA = New GDNReport_SUPRIYA()
        rpt.Site = Me.Site
        Return rpt
    End Function
