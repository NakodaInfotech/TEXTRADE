...
Public Class GDNReport_AVIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GDNReport_AVIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_AVIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_AVIS = New GDNReport_AVIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
