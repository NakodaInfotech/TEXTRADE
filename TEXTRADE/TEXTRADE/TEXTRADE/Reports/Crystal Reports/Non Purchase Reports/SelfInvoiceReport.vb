...
Public Class SelfInvoiceReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SelfInvoiceReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSelfInvoiceReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SelfInvoiceReport = New SelfInvoiceReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
