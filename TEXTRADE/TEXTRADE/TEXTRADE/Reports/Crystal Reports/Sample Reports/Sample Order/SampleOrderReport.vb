...
Public Class SampleOrderReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SampleOrderReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSampleOrderReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SampleOrderReport = New SampleOrderReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
