...
Public Class POItemStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.POItemStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOItemStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POItemStatusReport = New POItemStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
