...
Public Class POReport_YASHVI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.POReport_YASHVI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOReport_YASHVI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POReport_YASHVI = New POReport_YASHVI()
        rpt.Site = Me.Site
        Return rpt
    End Function
