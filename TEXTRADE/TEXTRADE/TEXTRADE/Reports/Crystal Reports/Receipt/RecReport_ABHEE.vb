...
Public Class RecReport_ABHEE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.RecReport_ABHEE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecReport_ABHEE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecReport_ABHEE = New RecReport_ABHEE()
        rpt.Site = Me.Site
        Return rpt
    End Function
