...
Public Class RecPartySummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.RecPartySummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecPartySummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecPartySummReport = New RecPartySummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
