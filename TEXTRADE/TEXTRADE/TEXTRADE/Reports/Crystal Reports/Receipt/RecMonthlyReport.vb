...
Public Class RecMonthlyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.RecMonthlyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecMonthlyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecMonthlyReport = New RecMonthlyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
