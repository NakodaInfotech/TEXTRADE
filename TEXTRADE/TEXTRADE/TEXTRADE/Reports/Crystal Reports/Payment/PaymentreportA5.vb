...
Public Class PaymentreportA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.PaymentreportA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentreportA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentreportA5 = New PaymentreportA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
