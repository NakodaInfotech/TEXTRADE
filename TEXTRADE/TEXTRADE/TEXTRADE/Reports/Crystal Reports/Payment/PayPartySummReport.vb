...
Public Class PayPartySummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.PayPartySummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayPartySummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayPartySummReport = New PayPartySummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
