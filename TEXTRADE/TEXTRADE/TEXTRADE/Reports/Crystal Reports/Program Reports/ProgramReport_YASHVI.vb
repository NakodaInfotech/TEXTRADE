...
Public Class ProgramReport_YASHVI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ProgramReport_YASHVI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.ProgramReport_YASHVI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProgramReport_YASHVI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProgramReport_YASHVI = New ProgramReport_YASHVI()
        rpt.Site = Me.Site
        Return rpt
    End Function
