...
Public Class ProgramReport_AVIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.ProgramReport_AVIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProgramReport_AVIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProgramReport_AVIS = New ProgramReport_AVIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
