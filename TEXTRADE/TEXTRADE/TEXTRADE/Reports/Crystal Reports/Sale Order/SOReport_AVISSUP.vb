...
Public Class SOReport_AVISSUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_AVISSUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_AVISSUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_AVISSUP = New SOReport_AVISSUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
