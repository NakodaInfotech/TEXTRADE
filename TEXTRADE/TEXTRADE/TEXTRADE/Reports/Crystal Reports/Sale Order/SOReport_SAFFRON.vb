...
Public Class SOReport_SAFFRON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_SAFFRON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_SAFFRON = New SOReport_SAFFRON()
        rpt.Site = Me.Site
        Return rpt
    End Function
