...
Public Class SOReport_MAHAVIR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_MAHAVIR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_MAHAVIR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_MAHAVIR = New SOReport_MAHAVIR()
        rpt.Site = Me.Site
        Return rpt
    End Function
