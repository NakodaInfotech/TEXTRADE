...
Public Class SOReport_KOTHARI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_KOTHARI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_KOTHARI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_KOTHARI = New SOReport_KOTHARI()
        rpt.Site = Me.Site
        Return rpt
    End Function
