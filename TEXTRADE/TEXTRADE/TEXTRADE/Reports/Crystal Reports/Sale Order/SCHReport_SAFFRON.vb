...
Public Class SCHReport_SAFFRON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SCHReport_SAFFRON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCHReport_SAFFRON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCHReport_SAFFRON = New SCHReport_SAFFRON()
        rpt.Site = Me.Site
        Return rpt
    End Function
