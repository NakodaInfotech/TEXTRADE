...
Public Class SOReport_AVIS_CAD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_AVIS_CAD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_AVIS_CAD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_AVIS_CAD = New SOReport_AVIS_CAD()
        rpt.Site = Me.Site
        Return rpt
    End Function
