...
Public Class SOItemStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOItemStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOItemStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOItemStatusReport = New SOItemStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
