...
Public Class SOStatusWithImgReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SOStatusWithImgReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOStatusWithImgReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOStatusWithImgReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOStatusWithImgReport = New SOStatusWithImgReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
