...
Public Class SOReport_KENCOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_KENCOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_KENCOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_KENCOT = New SOReport_KENCOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
