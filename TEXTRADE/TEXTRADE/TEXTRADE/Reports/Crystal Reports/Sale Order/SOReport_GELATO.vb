...
Public Class SOReport_GELATO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.SOReport_GELATO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOReport_GELATO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOReport_GELATO = New SOReport_GELATO()
        rpt.Site = Me.Site
        Return rpt
    End Function
