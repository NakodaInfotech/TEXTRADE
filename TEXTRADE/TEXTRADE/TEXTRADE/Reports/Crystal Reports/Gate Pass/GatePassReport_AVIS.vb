...
Public Class GatePassReport_AVIS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GatePassReport_AVIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GatePassReport_AVIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGatePassReport_AVIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GatePassReport_AVIS = New GatePassReport_AVIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
