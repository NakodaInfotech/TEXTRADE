...
Public Class VATSalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.VATSalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVATSalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VATSalesReport = New VATSalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
