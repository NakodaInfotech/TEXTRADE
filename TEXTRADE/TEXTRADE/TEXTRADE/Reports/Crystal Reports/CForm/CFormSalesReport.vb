...
Public Class CFormSalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.CFormSalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFormSalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFormSalesReport = New CFormSalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
