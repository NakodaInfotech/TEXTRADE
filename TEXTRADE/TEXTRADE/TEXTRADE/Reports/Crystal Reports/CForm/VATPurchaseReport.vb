...
Public Class VATPurchaseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.VATPurchaseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVATPurchaseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VATPurchaseReport = New VATPurchaseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
