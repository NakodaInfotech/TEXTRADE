...
Public Class PurchasePartyWiseSummPercent
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchasePartyWiseSummPercent.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.PurchasePartyWiseSummPercent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchasePartyWiseSummPercent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchasePartyWiseSummPercent = New PurchasePartyWiseSummPercent()
        rpt.Site = Me.Site
        Return rpt
    End Function
