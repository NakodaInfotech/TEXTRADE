...
Public Class YarnIssueReportA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.YarnIssueReportA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnIssueReportA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnIssueReportA5 = New YarnIssueReportA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
