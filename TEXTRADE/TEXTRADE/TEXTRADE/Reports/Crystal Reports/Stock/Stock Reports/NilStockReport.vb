...
Public Class NilStockReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.NilStockReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNilStockReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NilStockReport = New NilStockReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
