...
Public Class GRNReportCutting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GRNReportCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNReportCutting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNReportCutting = New GRNReportCutting()
        rpt.Site = Me.Site
        Return rpt
    End Function
