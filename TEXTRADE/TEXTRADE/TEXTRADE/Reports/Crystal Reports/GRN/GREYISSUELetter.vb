...
Public Class GREYISSUELetter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GREYISSUELetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGREYISSUELetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GREYISSUELetter = New GREYISSUELetter()
        rpt.Site = Me.Site
        Return rpt
    End Function
