...
Public Class GRNDYEING_BRILLANTO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GRNDYEING_BRILLANTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GRNDYEING_BRILLANTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNDYEING_BRILLANTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNDYEING_BRILLANTO = New GRNDYEING_BRILLANTO()
        rpt.Site = Me.Site
        Return rpt
    End Function
