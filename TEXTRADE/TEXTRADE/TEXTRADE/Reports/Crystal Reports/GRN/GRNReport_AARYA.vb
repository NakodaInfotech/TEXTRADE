...
Public Class GRNReport_AARYA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GRNReport_AARYA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNReport_AARYA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNReport_AARYA = New GRNReport_AARYA()
        rpt.Site = Me.Site
        Return rpt
    End Function
