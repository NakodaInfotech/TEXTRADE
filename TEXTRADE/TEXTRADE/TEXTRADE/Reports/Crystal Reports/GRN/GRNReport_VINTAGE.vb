...
Public Class GRNReport_VINTAGE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.GRNReport_VINTAGE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNReport_VINTAGE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNReport_VINTAGE = New GRNReport_VINTAGE()
        rpt.Site = Me.Site
        Return rpt
    End Function
