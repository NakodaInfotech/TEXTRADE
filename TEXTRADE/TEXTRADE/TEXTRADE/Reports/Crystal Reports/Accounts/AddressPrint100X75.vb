...
Public Class AddressPrint100X75
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.AddressPrint100X75.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAddressPrint100X75
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AddressPrint100X75 = New AddressPrint100X75()
        rpt.Site = Me.Site
        Return rpt
    End Function
