...
Public Class EnvelopeReportOld
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.EnvelopeReportOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEnvelopeReportOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EnvelopeReportOld = New EnvelopeReportOld()
        rpt.Site = Me.Site
        Return rpt
    End Function
