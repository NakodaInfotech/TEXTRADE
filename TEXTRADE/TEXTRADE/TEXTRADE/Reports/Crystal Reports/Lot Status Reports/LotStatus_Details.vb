...
Public Class LotStatus_Details
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotStatus_Details.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_Details
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_Details = New LotStatus_Details()
        rpt.Site = Me.Site
        Return rpt
    End Function
