...
Public Class LotStatus_SummValue
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LotStatus_SummValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotStatus_SummValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_SummValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_SummValue = New LotStatus_SummValue()
        rpt.Site = Me.Site
        Return rpt
    End Function
