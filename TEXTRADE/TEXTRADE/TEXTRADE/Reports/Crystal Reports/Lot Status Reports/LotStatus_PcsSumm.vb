...
Public Class LotStatus_PcsSumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotStatus_PcsSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_PcsSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_PcsSumm = New LotStatus_PcsSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
