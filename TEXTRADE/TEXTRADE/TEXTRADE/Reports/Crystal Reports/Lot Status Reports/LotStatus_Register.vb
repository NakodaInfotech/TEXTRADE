...
Public Class LotStatus_Register
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotStatus_Register.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_Register
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_Register = New LotStatus_Register()
        rpt.Site = Me.Site
        Return rpt
    End Function
