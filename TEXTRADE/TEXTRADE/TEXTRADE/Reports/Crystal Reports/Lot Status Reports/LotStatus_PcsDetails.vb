...
Public Class LotStatus_PcsDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LotStatus_PcsDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotStatus_PcsDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_PcsDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_PcsDetails = New LotStatus_PcsDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
