...
Public Class LotTaggingReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TEXTRADE.LotTaggingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotTaggingReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotTaggingReport = New LotTaggingReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
