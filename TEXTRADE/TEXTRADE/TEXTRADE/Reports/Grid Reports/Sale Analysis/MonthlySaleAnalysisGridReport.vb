        ...
        Try
            ...
            If CMBPRINTVALUE.Text = "Qty And Amt" Then
                ...
                For Each ROW As DataRow In DT.Rows
                    GRIDREPORT.Rows.Add(ROW("NAME"), Val(ROW("APR")), Val(ROW("APR (AMT)")), Val(ROW("MAY")), Val(ROW("MAY (AMT)")), Val(ROW("JUN")), Val(ROW("JUN (AMT)")), Val(ROW("JUL")), Val(ROW("JUL (AMT)")), Val(ROW("AUG")), Val(ROW("AUG (AMT)")), Val(ROW("SEP")), Val(ROW("SEP (AMT)")), Val(ROW("OCT")), Val(ROW("OCT (AMT)")), Val(ROW("NOV")), Val(ROW("NOV (AMT)")), Val(ROW("DEC")), Val(ROW("DEC (AMT)")), Val(ROW("JAN")), Val(ROW("JAN (AMT)")), Val(ROW("FEB")), Val(ROW("FEB (AMT)")), Val(ROW("MAR")), Val(ROW("MAR (AMT)")), Val(ROW("TOTALMTRS")), Val(ROW("TOTALAMT")))
                Next
