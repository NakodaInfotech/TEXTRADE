...
Public Class ItemShadeWiseJobberStockDetails
    ...
    Private Sub ItemShadeWiseJobberStockDetails_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub ItemShadeWiseJobberStockDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            fillgrid()
        Catch ex As Exception
            Throw ex
    ...
    Sub fillgrid()
        Try
            ...
            Dim dt As DataTable = objclsCMST.search(" NAME, JONO, TYPE, JODATE, ITEMNAME, COLOR, CATEGORYNAME, ROUND(SUM(TOTALMTRS),2) AS MTRS ", "", " JOBBERSTOCK ", TEMPCONDITION & STRSEARCH & " AND YEARID = " & YearId & " GROUP BY NAME, JONO, TYPE, JODATE, ITEMNAME, COLOR, CATEGORYNAME ORDER BY JONO ")
