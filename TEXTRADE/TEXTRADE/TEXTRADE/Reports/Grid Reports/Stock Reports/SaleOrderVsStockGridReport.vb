...
Public Class SaleOrderVsStockGridReport
    ...
    Sub FILLPENIDNGPOGRID()
        Try
            ...
            Dim DT As DataTable = OBJCMN.SEARCH("NAME, ORDERNO, DUEDATE, UNIT, SUM(PENDINGPCS)+SUM(OLDPENDINGPCS) AS PCS, ROUND(SUM(PENDINGMTRS)+SUM(OLDPENDINGMTRS),2) AS MTRS ", "", " PENDINGPURCHASEORDER ", " AND ITEMNAME = '" & GRIDBILL.GetFocusedRowCellValue("ITEMNAME") & "' AND ISNULL(DESIGNNO,'') = '" & GRIDBILL.GetFocusedRowCellValue("DESIGNNO") & "' AND SHADE = '" & GRIDBILL.GetFocusedRowCellValue("COLOR") & "' AND YEARID = " & YearId & SOCLAUSE & " GROUP BY NAME, ORDERNO, DUEDATE, UNIT " & HAVINGCLAUSE)
