...
Public Class OutStockReport
    ...
    Sub FILLGRID()
        Try
            ...
            Else
                DT = OBJCMN.search(" BARCODE, TYPE, PIECETYPE, ITEMNAME AS ITEM, QUALITY, DESIGNNO AS DESIGN, JOBBERNAME AS TONAME, COLOR, GODOWN, MTRS, FROMNO, UNIT, BALENO ", "", "  OUTBARCODESTOCK ", " AND YEARID = " & YearId)
            End If
