...
Public Class PartyWiseBaleRateReport
    ...
    Private Sub PartyWiseBaleRateReport_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            DTPARTYBILLDATE.Focus()
            'DTFOLLOWUPDATE.SelectAll()
            If DTPARTYBILLDATE.Text <> "__/__/____" Then fillgrid() Else MsgBox("Please Enter Followup Date")
    ...
    Sub fillgrid()
        Try
            ...
            Dim dt As DataTable
            dt = objclsCMST.search(" ENQ_NO AS ENQNO , ENQ_DATE AS DATE, ENQ_GIVENBY AS GIVENBY, ENQ_GIVENTO AS GIVENTO, ENQ_NEXTDATE AS NEXTDATE, ISNULL(SALESENQUIRY_FOLLOWUP.ENQ_NARRATION,'') AS NARRATION", "", "  SALESENQUIRY_FOLLOWUP", " AND SALESENQUIRY_FOLLOWUP.ENQ_NEXTDATE = '" & DTPARTYBILLDATE.Text & "'  AND SALESENQUIRY_FOLLOWUP.ENQ_YEARID = " & YearId & " ORDER BY SALESENQUIRY_FOLLOWUP.ENQ_NO")
    ...
    Private Sub PartyWiseBaleRateReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        ElseIf e.Alt = True And e.KeyCode = Keys.P Then
            Call TOOLEXCELL_Click(sender, e)
        ElseIf e.KeyCode = Keys.OemQuotes Then
            e.SuppressKeyPress = True
        End If
    End Sub

    Private Sub TOOLEXCELL_Click(sender As Object, e As EventArgs) Handles TOOLEXCELL.Click
        Try
            Dim PATH As String = "" = ""
    ...
    Private Sub DTPARTYBILLDATE_Click(sender As Object, e As EventArgs) Handles DTPARTYBILLDATE.Click
        DTPARTYBILLDATE.SelectAll()
    End Sub

    Private Sub DTPARTYBILLDATE_Validating(sender As Object, e As CancelEventArgs) Handles DTPARTYBILLDATE.Validating
        Try
