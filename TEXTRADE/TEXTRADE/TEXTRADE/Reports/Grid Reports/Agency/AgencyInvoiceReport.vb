...
Public Class AgencyInvoiceReport
    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            ...
            Dim dt As DataTable = objclsCMST.search(" CAST(0 AS BIT) AS CHK, AGENCYINVOICEMASTER.AINVOICE_NO, AGENCYINVOICEMASTER.AINVOICE_PARTYPONO, AGENCYINVOICEMASTER.AINVOICE_DATE, LEDGERS.Acc_cmpname AS BUYERNAME, SELLERLEDGERS.Acc_cmpname AS SELLERNAME, AGENCYINVOICEMASTER.AINVOICE_CRDAYS, AGENCYINVOICEMASTER.AINVOICE_LRNO, AGENCYINVOICEMASTER_DESC.AINVOICE_PCS, AGENCYINVOICEMASTER.AINVOICE_TOTALPCS, AGENCYINVOICEMASTER_DESC.AINVOICE_MTRS, AGENCYINVOICEMASTER.AINVOICE_TOTALMTRS, AGENCYINVOICEMASTER_DESC.AINVOICE_AMOUNT AS AMOUNT, AGENCYINVOICEMASTER.AINVOICE_TOTALAMT, AGENCYINVOICEMASTER.AINVOICE_CHARGES, AGENCYINVOICEMASTER.AINVOICE_REMARKS, ITEMMASTER.item_name, TRANSLEDGERS.Acc_cmpname AS TRANSPORT, AGENCYINVOICEMASTER_DESC.AINVOICE_RATE AS RATE", "", "AGENCYINVOICEMASTER INNER JOIN AGENCYINVOICEMASTER_DESC ON AGENCYINVOICEMASTER.AINVOICE_NO = AGENCYINVOICEMASTER_DESC.AINVOICE_NO INNER JOIN LEDGERS  ON AGENCYINVOICEMASTER.AINVOICE_LEDGERID = LEDGERS.Acc_ID INNER JOIN LEDGERS AS SELLERLEDGERS     ON AGENCYINVOICEMASTER.AINVOICE_PURLEDGERID = SELLERLEDGERS.Acc_ID INNER JOIN ITEMMASTER          ON AGENCYINVOICEMASTER_DESC.AINVOICE_ITEMID = ITEMMASTER.item_id LEFT JOIN LEDGERS AS TRANSLEDGERS ON AGENCYINVOICEMASTER.AINVOICE_TRANSID = TRANSLEDGERS.Acc_ID", " ORDER BY AGENCYINVOICEMASTER.AINVOICE_NO")
