    ...
    Sub FILLGRID()
        Try
            ...
            If CMBBUYER.Text <> "" Then
                If CMBBUYER.Text.Trim = "ABHEE FABRICS LLP [ BUYER ]" Then SOCLAUSE = SOCLAUSE & " AND  (ALLSALEORDER.[TYPE] = 'PURCHASEORDER' OR ALLSALEORDER.[TYPE] = 'POOPENING') " Else SOCLAUSE = SOCLAUSE & " and BUYERLEDGERS.ACC_CMPNAME='" & CMBBUYER.Text.Trim & "'"
            End If
            If CMBSELLER.Text <> "" Then
                If CMBSELLER.Text.Trim = "ABHEE FABRICS LLP [ SELLER ]" Then SOCLAUSE = SOCLAUSE & " AND (ALLSALEORDER.[TYPE] = 'SALEORDER' OR ALLSALEORDER.[TYPE] = 'OPENING') " Else SOCLAUSE = SOCLAUSE & " and SELLERLEDGERS.ACC_CMPNAME='" & CMBSELLER.Text.Trim & "'"
            End If
