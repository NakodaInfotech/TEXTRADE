    ...
    Private Sub CMDUPDATE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDUPDATE.Click
        Try
            ...
            If CMBTYPE.Text = "GRN" Then
                ...
                DT = OBJCMN.Execute_Any_String(" UPDATE PURCHASEMASTER SET PURCHASEMASTER.BILL_DYEINGID = " & DTLEDGER.Rows(0).Item("LEDGERID") & " FROM PURCHASEMASTER INNER JOIN PURCHASEMASTER_DESC ON PURCHASEMASTER.BILL_NO = PURCHASEMASTER_DESC.BILL_NO AND PURCHASEMASTER.BILL_REGISTERID = PURCHASEMASTER_DESC.BILL_REGISTERID AND PURCHASEMASTER.BILL_YEARID = PURCHASEMASTER_DESC.BILL_YEARID WHERE PURCHASEMASTER_DESC.BILL_GRNNO = " & Val(TXTGRNNO.Text.Trim) & " And PURCHASEMASTER_DESC.BILL_TYPE = 'Job Work' AND PURCHASEMASTER_DESC.BILL_YEARID = " & YearId, "", "")
