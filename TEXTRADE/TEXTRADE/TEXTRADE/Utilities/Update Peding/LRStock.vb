        ...
        Try
            ...
            If RBPENDING.Checked = True Then
                ...
                For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                    ...
                    If DTROW("TYPE") = "PURCHASE" Then DT = OBJCMN.Execute_Any_String(" UPDATE PURCHASEMASTER SET BILL_SOLD = 1 WHERE BILL_NO = " & DTROW("BILLNO") & " BILL_REGISTERID = " & DTROW("REGID") & " AND GDN_YEARID = " & YearId, "", "")
                    If DTROW("TYPE") = "OPENING" Then DT = OBJCMN.Execute_Any_String(" UPDATE STOCKMASTER SET SM_SOLD = 1 WHERE SM_LEDGERID = " & DTROW("LEDGERID") & "  AND SM_LEDGERIDTO = " & DTROW("LEDGERIDTO") & "  AND SM_BALENO = " & DTROW("BALENO") & " AND SM_YEARID = " & YearId, "", "")
            ...
            If RBENTERED.Checked = True Then
                ...
                For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                    ...
                    If DTROW("TYPE") = "PURCHASE" Then DT = OBJCMN.Execute_Any_String(" UPDATE PURCHASEMASTER SET BILL_SOLD = 0 WHERE BILL_NO = " & DTROW("BILLNO") & " BILL_REGISTERID = " & DTROW("REGID") & " AND GDN_YEARID = " & YearId, "", "")
                    If DTROW("TYPE") = "OPENING" Then DT = OBJCMN.Execute_Any_String(" UPDATE STOCKMASTER SET SM_SOLD = 0 WHERE SM_LEDGERID = " & DTROW("LEDGERID") & "  AND SM_LEDGERIDTO = " & DTROW("LEDGERIDTO") & "  AND SM_BALENO = " & DTROW("BALENO") & " AND SM_YEARID = " & YearId, "", "")
