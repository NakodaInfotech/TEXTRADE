                ...
                If DTTABLE.Rows.Count > 0 Then
                    ...
                    If DT1.Rows.Count > 0 Then
                        For Each dr As DataRow In DT1.Rows
                            GRIDCOVER.Rows.Add(0, dr("INVNO"), dr("REGNAME"), dr("INVINITIALS"), dr("PRINTINITIALS"), dr("NAME"), dr("AGENTNAME"), Format(Convert.ToDateTime(dr("INVDATE")), "dd/MM/yyyy"), dr("LRNO"), Format(Convert.ToDateTime(dr("LRDATE")), "dd/MM/yyyy"), dr("TRANSPORT"), dr("SHIPTO"), Val(dr("TOTALMTRS")), Val(dr("TOTALPCS")), Val(dr("GRANDTOTAL")))
                        Next
            ...
            If EDIT = True Then
                ...
                If DT.Rows.Count > 0 Then
                    ...
                    For Each dr As DataRow In DT.Rows
                        ...
                        GRIDCOVER.Rows.Add(dr("SRNO"), dr("INVNO"), dr("REGNAME"), dr("INVINITIALS"), dr("PRINTINITIALS"), dr("PARTYNAME"), dr("AGENTNAME"), Format(Convert.ToDateTime(dr("INVDATE")), "dd/MM/yyyy").ToString, dr("LRNO"), dr("LRDATE"), dr("TRANSPORT"), dr("SHIPTO"), Val(dr("TOTALMTRS")), Val(dr("TOTALPCS")), Val(dr("GRANDTOTAL")))
