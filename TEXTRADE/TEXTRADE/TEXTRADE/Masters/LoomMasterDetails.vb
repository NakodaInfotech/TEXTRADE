...
Public Class LoomMasterDetails
    ...
    Sub FILLGRID()
        Try
            ...
            Dim dt As DataTable = objclsCMST.search(" LEDGERS.Acc_cmpname AS NAME, LOOMMASTER.LOOM_TOTALLOOMS AS TOTALLOOMS, LOOMMASTER.LOOM_YEARID , LOOMMASTER.LOOM_ID AS LOOMID ", "", "  LOOMMASTER LEFT OUTER JOIN LOOMMASTER_DESC ON LOOMMASTER.LOOM_ID = LOOMMASTER_DESC.LOOM_ID AND LOOMMASTER.LOOM_TOTALLOOMS = LOOMMASTER_DESC.LOOM_NO INNER JOIN LEDGERS ON LOOMMASTER.LOOM_WEAVERID = LEDGERS.Acc_id ", "   and LOOMMASTER.LOOM_YEARID = " & YearId)
