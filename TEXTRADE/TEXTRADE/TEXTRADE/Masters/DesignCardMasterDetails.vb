...
Public Class DesignCardMasterDetails
    ...
    Public tempdesignno As Integer
    ...
    Private Sub DesignCardMasterDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub showform(ByVal editval As Boolean, ByVal SOno As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And GRIDBILL.RowCount > 0) Then
                Dim objPO As New DesignCardMaster
                objPO.MdiParent = MDIMain
                objPO.EDIT = editval
                objPO.tempdesignno = SOno
                objPO.Show()
            End If
        Catch ex As Exception
            Throw ex
