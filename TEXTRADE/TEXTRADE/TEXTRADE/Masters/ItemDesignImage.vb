...
NEXTLINE:
    ...
    Private Async Function Button1_ClickAsync(sender As Object, e As EventArgs) As Task Handles Button1.Click
        ...
        'Dim uploadUrl As String = "http://" & CATALOGIP & "/TEXTRADE/Upload.ashx"

        Dim fullUrl As String = CATALOGIP
        ...
        Dim lastSlashIndex As Integer = fullUrl.LastIndexOf("/")

        If lastSlashIndex > -1 Then
            uploadUrl = fullUrl.Substring(0, lastSlashIndex + 1)
        End If
        uploadUrl = uploadUrl + "Upload.ashx"
