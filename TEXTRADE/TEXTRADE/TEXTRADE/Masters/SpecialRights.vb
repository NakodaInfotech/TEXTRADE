...
Public Class SpecialRights
    ...
    Sub clear()
        ...
        CHKSALEMONTHLY.CheckState = CheckState.Checked
        CHKOVERDUE.CheckState = CheckState.Checked
        CHKPERFORMANCE.CheckState = CheckState.Checked
        ...
        CHKSHOWREMINDER.CheckState = CheckState.Checked
        CHKPOSOCHECKIN.CheckState = CheckState.Checked
    ...
    Private Sub CMDSAVE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDSAVE.Click
        ...
        Try
            ...
            If CHKSALEMONTHLY.Checked = True Then alParaval.Add(1) Else alParaval.Add(0)
            ...
            If CHKSHOWREMINDER.Checked = True Then alParaval.Add(1) Else alParaval.Add(0)
            If CHKPOSOCHECKIN.Checked = True Then alParaval.Add(1) Else alParaval.Add(0)
            If CHKOVERDUE.Checked = True Then alParaval.Add(1) Else alParaval.Add(0)
            If CHKPERFORMANCE.Checked = True Then alParaval.Add(1) Else alParaval.Add(0)
        ...
        Try
            If CMBUSER.Text.Trim <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    CHKSALEMONTHLY.Checked = dt.Rows(0).Item(18)
                    ...
                    CHKSHOWREMINDER.Checked = dt.Rows(0).Item("SHOWREMINDER")
                    CHKPOSOCHECKIN.Checked = dt.Rows(0).Item("ALLOWPOSOCHECKIN")

                    CHKOVERDUE.Checked = dt.Rows(0).Item("SHOWOVERDUE")
                    CHKPERFORMANCE.Checked = dt.Rows(0).Item("SHOWPERFORMANCE")
