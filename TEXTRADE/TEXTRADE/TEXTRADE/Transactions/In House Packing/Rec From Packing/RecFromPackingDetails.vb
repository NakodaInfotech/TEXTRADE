    ...
    Private Sub RecFromPackingDetails_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            ...
            If ClientName = "ANKUSH" Then
                gridbill.Columns("GRIDREMARKS").Caption = "Bale No"
            End If
        Catch ex As Exception
            Throw ex
        End Try
