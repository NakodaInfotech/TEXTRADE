...
Public Class IssueToDesigner
    ...
    '                If MsgBox("Delete MSI?", MsgBoxStyle.YesNo) = vbYes Then
    '                    Dim alParaval As New ArrayList
    '                    alParaval.Add(Val(TEMPISSNO))
    '                    alParaval.Add(CmpId)
    '                    alParaval.Add(YearId)

    '                    Dim ClsINCTAG As New ClsManualEntry()
