    ...
    Private Sub SaleOrderDetails_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            ...
            If ClientName = "DSM" Then
                ...
                GDESIGNERNAME.VisibleIndex = GDESIGNNO.VisibleIndex + 1
                GCOLOR.Visible = False
                GREFNO.Visible = False
                GGRIDSRNO.Visible = True

            End If
            If ClientName = "MAHAVIRPOLYCOT" Then
                GWIDTH.VisibleIndex = 8
                GWIDTH.Visible = True
