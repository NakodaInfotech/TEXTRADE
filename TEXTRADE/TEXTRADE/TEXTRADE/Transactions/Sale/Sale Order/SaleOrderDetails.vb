...
Public Class SaleOrderDetails
    ...
    Sub FILLGRID(ByVal TEMPCONDITION)
        Try
            ...
            If CHKPENDING.Checked = True And ClientName = "AVIS" Then TEMPCONDITION = TEMPCONDITION & " AND ISNULL(SALEORDER_DESC.SO_CLOSED,0) = 'FALSE' AND (ROUND(((ISNULL(SALEORDER_DESC.SO_MTRS,0) - ISNULL(SALEORDER_DESC.SO_RECDMTRS,0)) / ISNULL(SALEORDER_DESC.SO_MTRS,0))*100,2)) >= 90" If CHKPENDING.Checked = True And ClientName <> "AVIS" Then TEMPCONDITION = TEMPCONDITION & " AND ISNULL(SALEORDER_DESC.SO_CLOSED,0) = 'FALSE'"
