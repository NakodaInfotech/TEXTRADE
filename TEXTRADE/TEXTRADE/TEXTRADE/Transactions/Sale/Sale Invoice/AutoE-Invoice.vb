...
Public Class AutoEInvoice
    ...
    Private Sub InvoiceDetails_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        End Try
    End Sub
    Private Sub CMDGENERERATEEINV_Click(sender As Object, e As EventArgs) Handles CMDGENERERATEEINV.Click
        Try
        ...
        CType(gridbilldetails.MainView, DevExpress.XtraGrid.Views.Grid.GridView)
            ...
            For I As Integer = 0 To Val(gridbill.RowCount - 1)
                ...
                If ROW("CHK") = True Then
                    ...
                    InvoiceMaster.AutoEinv = True

                    'Generate E-Invoice
                    InvoiceMaster.TOOLEINV_Click(sender, e)
