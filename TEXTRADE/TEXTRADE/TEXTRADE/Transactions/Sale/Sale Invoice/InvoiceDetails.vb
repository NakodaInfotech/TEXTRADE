...
Public Class InvoiceDetails
    ...
    Private Sub InvoiceDetails_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
            If ClientName = "INDRAPUJAIMPEX" Or ClientName = "SOFTAS" Or ClientName = "KOTHARI" Or ClientName = "KOTHARINEW" Or ClientName = "PARTOBA" Or ClientName = "INDRAPUJAFABRICS" Or ClientName = "RAJDEEP" Then CHKBLANKPAPER.CheckState = CheckState.Checked
            ...
            If ClientName = "ABHEE" Or ClientName = "MASHOK" Then
                ...
                GCRDAYS.Visible = True
                GCRDAYS.VisibleIndex = GCHANGEDATE.VisibleIndex + 1
                GDUEDATE.Visible = True
                GDUEDATE.VisibleIndex = GCRDAYS.VisibleIndex + 1
            End If
