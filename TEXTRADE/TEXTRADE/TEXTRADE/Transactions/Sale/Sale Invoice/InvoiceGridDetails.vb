    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            ...
            Dim dt As DataTable = OBJCMN.SEARCH(" INVOICEMASTER.INVOICE_NO AS INVOICENO, INVOICEMASTER.INVOICE_DATE AS INVOICEDATE, ISNULL(INVOICEMASTER.INVOICE_LRNO, '') AS LRNO, ISNULL(INVOICEMASTER.INVOICE_GDNNO, '0') AS CHALLANNO, 
                         ...
                         ISNULL(GRIDTRANSLEDGERS.Acc_cmpname, '') AS GRIDTRANSE, ISNULL(GRIDPURLEDGERS.Acc_cmpname, '') AS GRIDPURNAME, ISNULL(INVOICEMASTER.INVOICE_COMPLAINT,'') AS COMPLAINT, 
                         ISNULL(INVOICEMASTER.INVOICE_COMPLAINTBY,'') AS COMPLAINTBY, ISNULL(INVOICEMASTER.INVOICE_COMPLAINTDATE,'') AS COMPLAINTDATE, INVOICEMASTER.INVOICE_CHANGEDATE AS CHANGEDATE,
                         INVOICEMASTER.INVOICE_CRDAYS AS CRDAYS, INVOICEMASTER.INVOICE_DUEDATE AS DUEDATE
