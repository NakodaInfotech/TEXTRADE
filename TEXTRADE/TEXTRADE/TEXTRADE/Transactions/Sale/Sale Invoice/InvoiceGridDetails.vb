    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            ...
            Dim dt As DataTable = OBJCMN.SEARCH(" INVOICEMASTER.INVOICE_NO AS INVOICENO, INVOICEMASTER.INVOICE_DATE AS INVOICEDATE, ISNULL(INVOICEMASTER.INVOICE_LRNO, '') AS LRNO, ISNULL(INVOICEMASTER.INVOICE_GDNNO, '0') AS CHALLANNO, 
                         ...
                         ISNULL(INVOICEMASTER.INVOICE_CHARGES, 0) AS CHARGES, ISNULL(INVOICEMASTER.INVOICE_TOTALTAXABLEAMT, 0) AS TOTALTAXABLEAMT, ISNULL(INVOICEMASTER.INVOICE_TOTALCGSTAMT, 0) AS TOTALCGSTAMT, 
                         ...
                         UPPER(DATENAME(MONTH, INVOICEMASTER.INVOICE_DATE)) AS MONTHNAME, ISNULL(INVOICEMASTER_DESC.INVOICE_QTY, 0) AS QTY, ISNULL(INVOICEMASTER_DESC.INVOICE_FOLDPER, 0) AS FOLDPER   ", "", " INVOICEMASTER INNER JOIN
