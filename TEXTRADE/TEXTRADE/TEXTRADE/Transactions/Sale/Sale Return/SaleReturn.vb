...
NORATE:
                ...
                Else
                    ...
                    TXTSGSTPER.Text = 0
                    If CHKEXPORTGST.CheckState = CheckState.Unchecked Then
                        If Val(dt.Rows(0).Item("RATE")) = 0 Or CHKEXPORTGST.Checked = True Then GoTo NORATE1
    ...
    Private Sub CMDSELECTCHALLAN_Click(sender As Object, e As EventArgs) Handles CMDSELECTCHALLAN.Click
        Try
            ...
            If DTTABLE.Rows.Count > 0 Then
                ...
                If DTTABLE.Rows(0).Item("FROMTYPE") = "GREYSALERETURN" Then
                    DT1 = OBJCMN.SEARCH(" GREYSALERETURNCHALLAN.GSRCH_NO AS GSRCHNO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') AS PIECETYPE, ISNULL(ITEMMASTER.item_name, '') AS ITEM, ISNULL(QUALITYMASTER.QUALITY_name, '') AS QUALITY,  '' AS DESIGN,  '' AS COLOR, SUM(ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_QTY, 0)) AS PCS, SUM(ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_MTRS, 0)) AS MTRS , ISNULL(HSN_CODE,'') AS HSNCODE, ISNULL(HSN_CGST,0) AS CGSTPER, ISNULL(HSN_SGST,0) AS SGSTPER, ISNULL(HSN_IGST,0) AS IGSTPER, 0 AS GDNSRNO,  '' AS BALENO,ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_GRIDREMARKS, '') AS PRINTDESC, ISNULL(UNIT_ABBR,'') AS UNIT, ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_RATE,0) AS RATE, ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_PER,'Mtrs') AS PER, ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_AMOUNT, 0) AS AMOUNT, 'GREYSALERETURN' AS FROMTYPE ", "", " GREYSALERETURNCHALLAN INNER JOIN GREYSALERETURNCHALLAN_DESC ON GREYSALERETURNCHALLAN.GSRCH_NO = GREYSALERETURNCHALLAN_DESC.GSRCH_NO AND GREYSALERETURNCHALLAN.GSRCH_YEARID = GREYSALERETURNCHALLAN_DESC.GSRCH_YEARID LEFT OUTER JOIN ITEMMASTER ON GREYSALERETURNCHALLAN_DESC.GSRCH_ITEMID = ITEMMASTER.item_id LEFT OUTER JOIN DESIGNMASTER ON GREYSALERETURNCHALLAN_DESC.GSRCH_DESIGNID = DESIGNMASTER.DESIGN_id LEFT OUTER JOIN COLORMASTER ON GREYSALERETURNCHALLAN_DESC.GSRCH_COLORID = COLORMASTER.COLOR_id LEFT OUTER JOIN QUALITYMASTER ON GREYSALERETURNCHALLAN_DESC.GSRCH_QUALITYID = QUALITYMASTER.QUALITY_ID LEFT OUTER JOIN PIECETYPEMASTER ON GREYSALERETURNCHALLAN_DESC.GSRCH_PIECETYPEID = PIECETYPEMASTER.PIECETYPE_id LEFT OUTER JOIN HSNMASTER ON ITEMMASTER.ITEM_HSNCODEID = HSNMASTER.HSN_ID LEFT OUTER JOIN UNITMASTER ON GSRCH_QTYUNITID = UNIT_ID ", "  and GREYSALERETURNCHALLAN.GSRCH_NO IN(" & TXTSRCHNO.Text.Trim & ")  and GREYSALERETURNCHALLAN.GSRCH_YEARID = " & YearId & " GROUP BY GREYSALERETURNCHALLAN.GSRCH_NO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') , ISNULL(ITEMMASTER.item_name, '') , ISNULL(QUALITYMASTER.QUALITY_name, ''),  ISNULL(HSN_CODE,'') , ISNULL(HSN_CGST,0) , ISNULL(HSN_SGST,0) , ISNULL(HSN_IGST,0)  ,ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_GRIDREMARKS, ''), ISNULL(UNIT_ABBR,''), ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_RATE,0), ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_PER,'Mtrs'), ISNULL(GREYSALERETURNCHALLAN_DESC.GSRCH_AMOUNT, 0)   order by GREYSALERETURNCHALLAN.GSRCH_NO ")
                Else
                    If ClientName = "SANGHVI" Or ClientName = "TINUMINU" Or ClientName = "AVIS" Then
                        DT1 = OBJCMN.SEARCH(" SALERETURNCHALLAN.SRCH_NO AS SRCHNO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') AS PIECETYPE, ISNULL(ITEMMASTER.item_name, '') AS ITEM, ISNULL(QUALITYMASTER.QUALITY_name, '') AS QUALITY, ISNULL(DESIGNMASTER.DESIGN_NO, '') AS DESIGN, ISNULL(COLORMASTER.COLOR_name, '') AS COLOR, SUM(ISNULL(SALERETURNCHALLAN_DESC.SRCH_QTY, 0)) AS PCS, SUM(ISNULL(SALERETURNCHALLAN_DESC.SRCH_MTRS, 0)) AS MTRS , ISNULL(HSN_CODE,'') AS HSNCODE, ISNULL(HSN_CGST,0) AS CGSTPER, ISNULL(HSN_SGST,0) AS SGSTPER, ISNULL(HSN_IGST,0) AS IGSTPER, 0 AS GDNSRNO, ISNULL(SALERETURNCHALLAN_DESC.SRCH_BALENO, '') AS BALENO,ISNULL(SALERETURNCHALLAN_DESC.SRCH_GRIDREMARKS, '') AS PRINTDESC, ISNULL(UNIT_ABBR,'') AS UNIT, ISNULL(SALERETURNCHALLAN_DESC.SRCH_RATE,0) AS RATE, ISNULL(SALERETURNCHALLAN_DESC.SRCH_PER,'Mtrs') AS PER, ISNULL(SALERETURNCHALLAN_DESC.SRCH_AMOUNT, 0) AS AMOUNT, 'SALERETURN' AS FROMTYPE ", "", " SALERETURNCHALLAN INNER JOIN SALERETURNCHALLAN_DESC ON SALERETURNCHALLAN.SRCH_NO = SALERETURNCHALLAN_DESC.SRCH_NO AND SALERETURNCHALLAN.SRCH_YEARID = SALERETURNCHALLAN_DESC.SRCH_YEARID LEFT OUTER JOIN ITEMMASTER ON SALERETURNCHALLAN_DESC.SRCH_ITEMID = ITEMMASTER.item_id LEFT OUTER JOIN DESIGNMASTER ON SALERETURNCHALLAN_DESC.SRCH_DESIGNID = DESIGNMASTER.DESIGN_id LEFT OUTER JOIN COLORMASTER ON SALERETURNCHALLAN_DESC.SRCH_COLORID = COLORMASTER.COLOR_id LEFT OUTER JOIN QUALITYMASTER ON SALERETURNCHALLAN_DESC.SRCH_QUALITYID = QUALITYMASTER.QUALITY_ID LEFT OUTER JOIN PIECETYPEMASTER ON SALERETURNCHALLAN_DESC.SRCH_PIECETYPEID = PIECETYPEMASTER.PIECETYPE_id LEFT OUTER JOIN HSNMASTER ON ITEMMASTER.ITEM_HSNCODEID = HSNMASTER.HSN_ID LEFT OUTER JOIN UNITMASTER ON SRCH_QTYUNITID = UNIT_ID ", "  and SALERETURNCHALLAN.SRCH_NO IN(" & TXTSRCHNO.Text.Trim & ")  and SALERETURNCHALLAN.SRCH_YEARID = " & YearId & " GROUP BY SALERETURNCHALLAN.SRCH_NO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') , ISNULL(ITEMMASTER.item_name, '') , ISNULL(QUALITYMASTER.QUALITY_name, ''), ISNULL(DESIGN_NO,''), ISNULL(COLORMASTER.COLOR_name, '') , ISNULL(HSN_CODE,'') , ISNULL(HSN_CGST,0) , ISNULL(HSN_SGST,0) , ISNULL(HSN_IGST,0) ,ISNULL(SALERETURNCHALLAN_DESC.SRCH_BALENO, '') ,ISNULL(SALERETURNCHALLAN_DESC.SRCH_GRIDREMARKS, ''), ISNULL(UNIT_ABBR,''), ISNULL(SALERETURNCHALLAN_DESC.SRCH_RATE,0), ISNULL(SALERETURNCHALLAN_DESC.SRCH_PER,'Mtrs'), ISNULL(SALERETURNCHALLAN_DESC.SRCH_AMOUNT, 0)   order by SALERETURNCHALLAN.SRCH_NO ")
                    ElseIf ClientName = "MMC" Then
                        DT1 = OBJCMN.SEARCH(" SALERETURNCHALLAN.SRCH_NO AS SRCHNO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') AS PIECETYPE, ISNULL(ITEMMASTER.item_name, '') AS ITEM, ISNULL(QUALITYMASTER.QUALITY_name, '') AS QUALITY,  '' AS DESIGN,  '' AS COLOR, SUM(ISNULL(SALERETURNCHALLAN_DESC.SRCH_QTY, 0)) AS PCS, SUM(ISNULL(SALERETURNCHALLAN_DESC.SRCH_MTRS, 0)) AS MTRS , ISNULL(HSN_CODE,'') AS HSNCODE, ISNULL(HSN_CGST,0) AS CGSTPER, ISNULL(HSN_SGST,0) AS SGSTPER, ISNULL(HSN_IGST,0) AS IGSTPER, 0 AS GDNSRNO,  '' AS BALENO,ISNULL(SALERETURNCHALLAN_DESC.SRCH_GRIDREMARKS, '') AS PRINTDESC, ISNULL(UNIT_ABBR,'') AS UNIT, ISNULL(SALERETURNCHALLAN_DESC.SRCH_RATE,0) AS RATE, ISNULL(SALERETURNCHALLAN_DESC.SRCH_PER,'Mtrs') AS PER, ISNULL(SALERETURNCHALLAN_DESC.SRCH_AMOUNT, 0) AS AMOUNT, 'SALERETURN' AS FROMTYPE ", "", " SALERETURNCHALLAN INNER JOIN SALERETURNCHALLAN_DESC ON SALERETURNCHALLAN.SRCH_NO = SALERETURNCHALLAN_DESC.SRCH_NO AND SALERETURNCHALLAN.SRCH_YEARID = SALERETURNCHALLAN_DESC.SRCH_YEARID LEFT OUTER JOIN ITEMMASTER ON SALERETURNCHALLAN_DESC.SRCH_ITEMID = ITEMMASTER.item_id LEFT OUTER JOIN DESIGNMASTER ON SALERETURNCHALLAN_DESC.SRCH_DESIGNID = DESIGNMASTER.DESIGN_id LEFT OUTER JOIN COLORMASTER ON SALERETURNCHALLAN_DESC.SRCH_COLORID = COLORMASTER.COLOR_id LEFT OUTER JOIN QUALITYMASTER ON SALERETURNCHALLAN_DESC.SRCH_QUALITYID = QUALITYMASTER.QUALITY_ID LEFT OUTER JOIN PIECETYPEMASTER ON SALERETURNCHALLAN_DESC.SRCH_PIECETYPEID = PIECETYPEMASTER.PIECETYPE_id LEFT OUTER JOIN HSNMASTER ON ITEMMASTER.ITEM_HSNCODEID = HSNMASTER.HSN_ID LEFT OUTER JOIN UNITMASTER ON SRCH_QTYUNITID = UNIT_ID ", "  and SALERETURNCHALLAN.SRCH_NO IN(" & TXTSRCHNO.Text.Trim & ")  and SALERETURNCHALLAN.SRCH_YEARID = " & YearId & " GROUP BY SALERETURNCHALLAN.SRCH_NO, ISNULL(PIECETYPEMASTER.PIECETYPE_name,'') , ISNULL(ITEMMASTER.item_name, '') , ISNULL(QUALITYMASTER.QUALITY_name, ''),  ISNULL(HSN_CODE,'') , ISNULL(HSN_CGST,0) , ISNULL(HSN_SGST,0) , ISNULL(HSN_IGST,0)  ,ISNULL(SALERETURNCHALLAN_DESC.SRCH_GRIDREMARKS, ''), ISNULL(UNIT_ABBR,''), ISNULL(SALERETURNCHALLAN_DESC.SRCH_RATE,0), ISNULL(SALERETURNCHALLAN_DESC.SRCH_PER,'Mtrs'), ISNULL(SALERETURNCHALLAN_DESC.SRCH_AMOUNT, 0)   order by SALERETURNCHALLAN.SRCH_NO ")
                    Else
...
#Region "AUTOSEARCHTEXTBOX"
    ...
    Public Sub CreateFilterTextBoxes()
        ...
        '        txt.Top = 19 ' Or a header-compliant Y offset
        '        txt.Tag = col.Index
        ...
        Dim yPos As Integer = GRIDBILL.Top + GRIDBILL.ColumnHeadersHeight - 49
