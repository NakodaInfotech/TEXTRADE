    ...
    Private Sub GreyIssueProcessDetails_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            ...
            If ClientName = "MMC" Or ClientName = "SWPL" Then
                ...
                GBALENO.VisibleIndex = GITEMNAME.VisibleIndex + 1
                GDESIGNNO.Visible = True
                GDESIGNNO.VisibleIndex = GBALENO.VisibleIndex + 1
                GSHADE.Visible = True
                GSHADE.VisibleIndex = GDESIGNNO.VisibleIndex + 1
            End If
        Catch ex As Exception
            Throw ex
        End Try
