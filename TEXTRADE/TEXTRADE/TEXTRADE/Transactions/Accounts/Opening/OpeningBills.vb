...
Public Class OpeningBills
    ...
    Private Sub cmdok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            'WHEN ADDING CLOUMNS HERE DONT FORGET TO MAKE CHANHES IN FOLLOWING SP
            'SP_OPENINGBILL_UPLOAD
        ...
        Try
            ...
            If GRIDDOUBLECLICK = False Then
                If CHKDISPUTE.Checked = True Then
                    GRIDOPENING.Rows.Add(TXTSRNO.Text.Trim, CMBTYPE.Text.Trim, CMBREGISTER.Text.Trim, TXTBILLNO.Text.Trim, TXTYEAR.Text.Trim, Format(BILLDATE.Value.Date, "dd/MM/yyyy"), TXTCRDAYS.Text.Trim, Format(DUEDATE.Value.Date, "dd/MM/yyyy"), CMBAGENT.Text.Trim, TXTREMARKS.Text.Trim, 1, CMBDELIVERYAT.Text.Trim, Val(TXTPCS.Text.Trim), Val(TXTMTRS.Text.Trim), Val(TXTTOTALAMT.Text.Trim), Val(TXTCHARGES.Text.Trim), Val(TXTTAXABLEAMT.Text.Trim), Val(TXTCGSTPER.Text.Trim), Val(TXTCGSTAMT.Text.Trim), Val(TXTSGSTPER.Text.Trim), Val(TXTSGSTAMT.Text.Trim), Val(TXTIGSTPER.Text.Trim), Val(TXTIGSTAMT.Text.Trim), Val(TXTGRANDTOTAL.Text.Trim), Val(TXTAMT.Text.Trim), 0, 0, 0, 0, "", 0, "", 0, "", "", CHKINTCALC.Checked, "", "", "", "", Format(BILLDATE.Value.Date, "dd/MM/yyyy"))
                Else
                    GRIDOPENING.Rows.Add(TXTSRNO.Text.Trim, CMBTYPE.Text.Trim, CMBREGISTER.Text.Trim, TXTBILLNO.Text.Trim, TXTYEAR.Text.Trim, Format(BILLDATE.Value.Date, "dd/MM/yyyy"), TXTCRDAYS.Text.Trim, Format(DUEDATE.Value.Date, "dd/MM/yyyy"), CMBAGENT.Text.Trim, TXTREMARKS.Text.Trim, 0, CMBDELIVERYAT.Text.Trim, Val(TXTPCS.Text.Trim), Val(TXTMTRS.Text.Trim), Val(TXTTOTALAMT.Text.Trim), Val(TXTCHARGES.Text.Trim), Val(TXTTAXABLEAMT.Text.Trim), Val(TXTCGSTPER.Text.Trim), Val(TXTCGSTAMT.Text.Trim), Val(TXTSGSTPER.Text.Trim), Val(TXTSGSTAMT.Text.Trim), Val(TXTIGSTPER.Text.Trim), Val(TXTIGSTAMT.Text.Trim), Val(TXTGRANDTOTAL.Text.Trim), Val(TXTAMT.Text.Trim), 0, 0, 0, 0, "", 0, "", 0, "", "", CHKINTCALC.Checked, "", "", "", "", Format(BILLDATE.Value.Date, "dd/MM/yyyy"))
                End If
                getsrno(GRIDOPENING)
            Else
