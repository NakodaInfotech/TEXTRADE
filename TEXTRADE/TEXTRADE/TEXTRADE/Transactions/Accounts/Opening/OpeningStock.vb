        ...
        Try
            ...
            If dttable.Rows.Count > 0 Then
                ...
                For Each DR As DataRow In dttable.Rows
                    ...
                    gridstock.Rows.Add(Val(DR("GRIDSRNO")), DR("SMNO"), DR("LOTNO"), DR("PIECETYPE"), DR("MERCHANT"), DR("QUALITY"), DR("DESIGN"), DR("COLOR"), DR("PROCESS"), DR("NAME"), DR("TONAME"), Val(DR("BILLNO")), DR("GODOWN"), Format(Val(DR("CUT")), "0.00"), Val(DR("WT")), DR("UNIT"), Val(DR("PCS")), Format(Val(DR("MTRS")), "0.00"), DR("PER").ToString, DR("RACK"), DR("SHELF"), Format(Val(DR("RATE")), "0.00"), Format(Val(DR("AMOUNT")), "0.00"), Format(Val(DR("ADDLESS")), "0.00"), Format(Val(DR("NETTRATE")), "0.00"), DR("PARTYCHNO"), DR("BALENO"), DR("GRIDREMARKS"), DR("DYEINGJOB"), DR("REMARKS"), DR("BARCODE"), DR("DONE"), Format(Val(DR("OUTPCS")), "0.00"), Format(Val(DR("OUTMTRS")), "0.00"))
