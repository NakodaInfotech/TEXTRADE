...
Public Class Receipt
    ...
    Private Sub txtamt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtamt.KeyPress, txttotal.KeyPress, txtchqamt.KeyPress, txtdescamt.KeyPress
    ...
    Private Sub Receipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim DT As DataTable = OBJCLRECEIPT.selectbill_edit(TEMPRECEIPTNO, TEMPREGNAME, CmpId, Locationid, YearId)
    ...
    Sub SETGRIDINVOICE(ByVal DT As DataTable)
        Try
            ...
            gridbill.Columns(i).ReadOnly = True
            gridbill.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
            i += 1
    ...
    Private Sub txtamt_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtamt.Validating
        Try
            ...
            If txtsrno.Text.Trim.Length > 0 And Val(txtamt.Text) > 0 Then
                ...
                If cmbpaytype.Text = "New Ref" Then txtnarr.Text = recreginitial & "-" & Val(txtaccno.Text.Trim)
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            If EDIT = True Then
                ...
                Dim OBJCMN As New ClsCommon
                Dim DT As DataTable = OBJCMN.Execute_Any_String("UPDATE RECEIPTMASTER SET RECEIPT_PRINT = 1 FROM RECEIPTMASTER INNER JOIN REGISTERMASTER ON RECEIPT_REGISTERID = REGISTER_ID WHERE RECEIPT_NO = " & Val(txtaccno.Text.Trim) & " and REGISTERMASTER.REGISTER_NAME = '" & cmbregister.Text.Trim & "' AND RECEIPT_YEARID = " & YearId, "", "")
            End If
        Catch ex As Exception
            Throw ex
        End Try
...
1:
    ...
    Private Sub Receipt_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        If TEMPAUTOENTRY = True Then
            ...
            cmbname.Focus()
            If ClientName = "CC" Or ClientName = "C3" Then cmbaccname.Text = "CASH" Else cmbaccname.Text = "Cash In Hand"
