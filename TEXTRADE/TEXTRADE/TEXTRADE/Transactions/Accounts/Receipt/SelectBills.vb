...
Public Class SelectBills
        ...
        Try
            ...
            Else
                For i As Integer = 0 To gridrec.RowCount - 1
                    Dim dtrow As DataRow = gridrec.GetDataRow(i)
                    If Convert.ToBoolean(dtrow("CHK")) = True Then
                        DTBILLS.Rows.Add(dtrow("SRNO"), dtrow("REFNO"), dtrow("DATE"))
                    End If
                Next
    ...
    Private Sub SelectBills_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            If ClientName = "ABHEE" Then
                Me.Width += 200
                griddetails.Width += 200
                GSELLERNAME.Visible = True
            End If
        Catch ex As Exception
            Throw ex
        End Try
