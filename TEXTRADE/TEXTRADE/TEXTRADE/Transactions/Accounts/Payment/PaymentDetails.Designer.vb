...
Partial Class PaymentDetails
    ...
    Private Sub InitializeComponent()
        ...
        Me.gridpayment.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GCHK, Me.GSRNO, Me.gname, Me.gdate, Me.gtotal, Me.gregisterid, Me.gchq, Me.gbankname, Me.GBILLREMARKS, Me.gremarks, Me.GAGENTNAME, Me.GPARTYBANK, Me.GACCTYPE, Me.GACCNO, Me.GIFSC, Me.GBRANCH, Me.GBANKCITY, Me.GGROUPNAME, Me.GSPECIALREMARK, Me.GCREATEDBY, Me.GPARTYMAILID, Me.GAGENTMAILID, Me.GWHATSAPP, Me.GPRINT})
        ...
        Me.GCREATEDBY.VisibleIndex = 18
        '
        'GPARTYMAILID
        '
        Me.GPARTYMAILID.Caption = "Party Mail Id"
        Me.GPARTYMAILID.FieldName = "PARTYEMAILID"
        Me.GPARTYMAILID.Name = "GPARTYMAILID"
        Me.GPARTYMAILID.OptionsColumn.AllowEdit = False
        '
        'GAGENTMAILID
        '
        Me.GAGENTMAILID.Caption = "AGENTMAILID"
        Me.GAGENTMAILID.FieldName = "AGENTEMAILID"
        Me.GAGENTMAILID.Name = "GAGENTMAILID"
        Me.GAGENTMAILID.OptionsColumn.AllowEdit = False
        '
        'GWHATSAPP
        '
        Me.GWHATSAPP.Caption = "PARTYWHATSAPP"
    ...
    Friend WithEvents GPARTYMAILID As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GAGENTMAILID As DevExpress.XtraGrid.Columns.GridColumn
