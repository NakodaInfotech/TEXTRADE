    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            ...
            Dim dt As DataTable = OBJCMN.SEARCH(" AGENCYINVOICEMASTER.AINVOICE_NO AS INVOICENO, AGENCYINVOICEMASTER.AINVOICE_DATE AS INVOICEDATE, ISNULL(AGENCYINVOICEMASTER.AINVOICE_LRNO, '') AS LRNO, 
                         ...
                         ISNULL(AGENCYINVOICEMASTER_DESC.AINVOICE_FOLDPER, 0) AS FOLDPER, ISNULL(AGENCYINVOICEMASTER.AINVOICE_COMPLAINT,'') AS COMPLAINT, 
                         ISNULL(AGENCYINVOICEMASTER.AINVOICE_COMPLAINTBY,'') AS COMPLAINTBY, ISNULL(AGENCYINVOICEMASTER.AINVOICE_COMPLAINTDATE,'') AS COMPLAINTDATE   ", "", " AGENCYINVOICEMASTER INNER JOIN
