...
Public Class OpeningAgencySaleOrder
    ...
    Sub getmax_OPSO_no()
        ...
        DTTABLE = getmax(" isnull(max(OPASO_no),0) + 1 ", "OPENINGAGENCYSALEORDER", " AND OPASO_cmpid=" & CmpId & " and OPASO_locationid=" & Locationid & " and OPASO_yearid=" & YearId)
    ...
    Private Function errorvalid() As Boolean
        ...
        If CMBPACKING.Text.Trim.Length = 0 Then
            EP.SetError(CMBPACKING, " Please Fill Seller Name ")
            bln = False
        End If
        ...
        If Val(TXTOPSONO.Text.Trim) > 0 And EDIT = False Then
            ...
            Dim dttable As DataTable = OBJCMN.SEARCH("  ISNULL(OPASO_no, 0) AS OPSONO ", "", " OPENINGAGENCYSALEORDER ", "  AND OPENINGAGENCYSALEORDER.OPASO_no=" & TXTOPSONO.Text.Trim & " AND OPENINGAGENCYSALEORDER.OPASO_CMPID = " & CmpId & " AND OPENINGAGENCYSALEORDER.OPASO_LOCATIONID = " & Locationid & " AND OPENINGAGENCYSALEORDER.OPASO_YEARID = " & YearId)
            If dttable.Rows.Count > 0 Then
...
line1:
    ...
    Private Sub OpeningAgencySaleOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim objclsSO As New ClsOpeningAgencySaleOrder()
    ...
    Private Sub OpeningAgencySaleOrder_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            ...
            ElseIf e.Alt = True And e.KeyCode = Windows.Forms.Keys.F1 Then
                Dim OBJINVDTLS As New OpeningAgencySaleOrderDetails
        ...
        Try
            If EDIT = True Then
                ...
                If tempMsg = vbYes Then
                    ...
                    Dim clspo As New ClsOpeningAgencySaleOrder
        ...
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                ...
                If TEMPOPSONO > 0 Then
                    EDIT = True
                    OpeningAgencySaleOrder_Load(sender, e)
                Else
                    clear()
                    EDIT = False
                End If
...
line1:
    ...
    Private Sub OpenToolStripButton_Click(sender As Object, e As EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objpodtls As New OpeningAgencySaleOrderDetails
