...
Imports BL
Public Class AgencyManualMatching
    ...
    Sub GETMAXNO_MATCH()
        ...
        DTTABLE = getmax(" isnull(max(AMATCH_NO),0) + 1 ", " AGENCYMANUALMATCHING ", " AND AMATCH_YEARid=" & YearId)
...
LINE1:
    ...
    Private Sub AgencyManualMatching_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub AgencyManualMatching_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
...
LINE1:
            ...
            If Val(TXTMATCHNO.Text) - 1 >= TEMPMATCHNO Then
                EDIT = True
                AgencyManualMatching_Load(sender, e)
            Else
                clear()
                EDIT = False
            End If
