...
Public Class YarnInterGodownTransferDetails
    ...
    Private Sub YarnInterGodownTransferDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            Dim OBJGODOWN As New ClsYarnInterGodownTransfer
    ...
    Private Sub YarnInterGodownTransferDetails_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            Dim DTROW() As DataRow
            DTROW = USERRIGHTS.Select("FormName = 'YARNINTERGODOWN'")
