...
Public Class YarnReturnPurchase
    ...
    Public TEMPYARNRETNO As Integer          'used for editing
    ...
    Sub getmaxno()
        ...
        DTTABLE = getmax(" isnull(max(YARNRET_NO),0) + 1 ", " YARNPURCHASERETURN ", " AND YARNRET_cmpid=" & CmpId & " and YARNRET_yearid=" & YearId)
    ...
    Private Sub cmdok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            Dim objCUTTING As New ClsYarnReturnPurchase()
