...
Public Class ProductionFloorReturn
    Public EDIT As Boolean          'used for editing
    Dim IntResult As Integer
    Dim GRIDDOUBLECLICK As Boolean
    Dim GRIDUPLOADDOUBLECLICK As Boolean
    Public TEMPPRODRETNO As Integer          'used for editing
    ...
    Sub getmaxno()
        ...
        DTTABLE = getmax(" isnull(max(PRODRET_NO),0) + 1 ", " PRODUCTIONFLOORRETURN ", " AND PRODRET_cmpid=" & CmpId & " and PRODRET_yearid=" & YearId)
        If DTTABLE.Rows.Count > 0 Then TXTPRETURN.Text = DTTABLE.Rows(0).Item(0)
    End Sub
        ...
        Try
            ...
            If TXTCHALLANNO.Text.Trim <> "" Then
                If (EDIT = False) Or (EDIT = True And LCase(PARTYCHALLANNO) <> LCase(TXTCHALLANNO.Text.Trim)) Then
                    ...
                    Dim DT As DataTable = objclscommon.search(" PRODRET_challanno", "", " PRODUCTIONFLOORRETURN ", " and PRODRET_challanno = '" & TXTCHALLANNO.Text.Trim & "' AND PRODRET_YEARID =" & YearId)
            ...
            If PRETDATE.Text = "__/__/____" Then
                EP.SetError(PRETDATE, " Please Enter Proper Date")
                bln = False
            Else
                If Not datecheck(PRETDATE.Text) Then
                    EP.SetError(PRETDATE, "Date not in Accounting Year")
                    bln = False
                End If
            End If

            If Val(TXTPRETURN.Text.Trim) = 0 Then
                EP.SetError(TXTPRETURN, "Enter Job Out No")
                bln = False
            End If
    ...
    Private Sub cmdok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            alParaval.Add(Format(Convert.ToDateTime(PRETDATE.Text).Date, "MM/dd/yyyy"))
            ...
            Dim objCUTTING As New ClsProductionFloorReturn()
            ...
            If EDIT = False Then
                ...
                TXTPRETURN.Text = DTTABLE.Rows(0).Item(0)
            ...
            ElseIf EDIT = True Then
                ...
                alParaval.Add(TEMPPRODRETNO)
                IntResult = objCUTTING.UPDATE()
                MsgBox("Details Updated")
                PRINTREPORT(TEMPPRODRETNO)
    ...
    Sub SAVEUPLOAD()
        ...
        Try
            Dim OBJBILL As New ClsProductionFloorReturn
    ...
    Private Sub JOBOUT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim objJO As New ClsProductionFloorReturn()
                Dim ALPARAVAL As New ArrayList
                ALPARAVAL.Add(TEMPPRODRETNO)
                ALPARAVAL.Add(CmpId)
                ALPARAVAL.Add(YearId)
                objJO.alParaval = ALPARAVAL
                Dim dttable As DataTable = objJO.selectPROD(TEMPPRODRETNO, CmpId, YearId)

                If dttable.Rows.Count > 0 Then

                    For Each dr As DataRow In dttable.Rows

                        TXTPRETURN.Text = TEMPPRODRETNO
                        PRETDATE.Text = Format(Convert.ToDateTime(dr("DATE")).Date, "dd/MM/yyyy")
                    ...
                    Dim OBJCMN As New ClsCommon
                    dttable = OBJCMN.search(" PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_SRNO AS GRIDSRNO, PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_REMARKS AS REMARKS, PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_NAME AS NAME, PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_PHOTO AS IMGPATH ", "", " PRODUCTIONFLOORRETURN_UPLOAD ", " AND PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_NO = " & TEMPPRODRETNO & " AND PRODRET_YEARID = " & YearId & " ORDER BY PRODUCTIONFLOORRETURN_UPLOAD.PRODRET_SRNO")
                    If dttable.Rows.Count > 0 Then
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim OBJEMB As New ProductionFloorReturnDetails
    ...
    Private Sub tstxtbillno_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tstxtbillno.Validating
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                GRIDYARN.RowCount = 0
                TEMPPRODRETNO = Val(tstxtbillno.Text)
                If TEMPPRODRETNO > 0 Then
                    EDIT = True
    ...
    Private Sub toolprevious_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles toolprevious.Click
        Try
            ...
            GRIDYARN.RowCount = 0
LINE1:
            TEMPPRODRETNO = Val(TXTPRETURN.Text) - 1
            If TEMPPRODRETNO > 0 Then
                EDIT = True
                JOBOUT_Load(sender, e)
            Else
                ...
                EDIT = False
            End If
            If GRIDYARN.RowCount = 0 And TEMPPRODRETNO > 1 Then
                TXTPRETURN.Text = TEMPPRODRETNO
                GoTo LINE1
            End If
        Catch ex As Exception
...
LINE1:
            TEMPPRODRETNO = Val(TXTPRETURN.Text) + 1
            getmaxno()
            Dim MAXNO As Integer = TXTPRETURN.Text.Trim
            clear()
            If Val(TXTPRETURN.Text) - 1 >= TEMPPRODRETNO Then
                EDIT = True
                JOBOUT_Load(sender, e)
            Else
                clear()
                EDIT = False
            End If
            If GRIDYARN.RowCount = 0 And TEMPPRODRETNO < MAXNO Then
                TXTPRETURN.Text = TEMPPRODRETNO
                GoTo LINE1
            End If
        Catch ex As Exception
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            If EDIT = True Then PRINTREPORT(TEMPPRODRETNO)
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        Try
            If EDIT = True Then
                ...
                Dim ALPARAVAL As New ArrayList
                Dim OBJEMB As New ClsProductionFloorReturn
    ...
    Private Sub JODATE_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles PRETDATE.GotFocus
        PRETDATE.SelectAll()
    End Sub

    Private Sub JODATE_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles PRETDATE.Validating
        Try
            If PRETDATE.Text.Trim <> "__/__/____" Then
                'PARSING DATE FORMATS WHETHER THEY ARE PROPER OR NOT
                Dim TEMP As DateTime
                If Not DateTime.TryParse(PRETDATE.Text, TEMP) Then
