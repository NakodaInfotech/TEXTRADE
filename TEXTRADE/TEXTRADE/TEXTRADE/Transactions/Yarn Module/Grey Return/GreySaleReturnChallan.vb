...
Imports BL
Public Class GreySaleReturnChallan
    ...
    Sub GETMAXNO()
        Try
            ...
            DTTABLE = getmax(" isnull(max(GSRCH_no),0) + 1 ", " GREYSALERETURNCHALLAN ", " and GSRCH_yearid=" & YearId)
    ...
    Private Sub cmdok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMDOK.Click
        Try
            ...
            Dim OBJSR As New ClsGreySaleReturnChallan()
    ...
    Sub PRINTREPORT(ByVal SRNO As Integer)
        Try
            If MsgBox("Wish to Print Sale Return?", MsgBoxStyle.YesNo) = vbYes Then
                ...
                OBJPUR.WHERECLAUSE = "{GREYSALERETURNCHALLAN.GSRCH_NO}=" & Val(SRNO) & " and {GREYSALERETURNCHALLAN.GSRCH_yearid}=" & YearId
                OBJPUR.Show()
            End If
        Catch ex As Exception
            Throw ex
...
NEXTLINE:
    ...
    Private Sub SaleReturnChallan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim DTROW() As DataRow = USERRIGHTS.Select("FormName = 'GREYSALE RETURN'")
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim OBJSR As New GREYSaleReturnChallanDetails
...
LINE1:
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDDELETE.Click
        Try
            ...
            If EDIT = True Then
                ...
                If lbllocked.Visible = True Then
                    MsgBox("Grey Sale Return Challan Locked", MsgBoxStyle.Critical)
                    Exit Sub
                End If

                If MsgBox("Delete Grey Sale Return Challan?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
                ...
                MsgBox("Grey Sale Return Challan Deleted")
                CLEAR()
                EDIT = False
    ...
    Private Function CHECKBARCODE() As Boolean
        Try
            Dim BLN As Boolean = True
            Dim OBJCMN As New ClsCommon
            Dim DT As DataTable = OBJCMN.SEARCH(" ISNULL(GSRCH_BARCODE,'') AS BARCODE ", "", " GREYSALERETURNCHALLAN_DESC ", " AND GREYSALERETURNCHALLAN_DESC.GSRCH_YEARID =  " & YearId)
            If DT.Rows.Count > 0 Then
    ...
    Private Sub TOOLWHATSAPP_Click(sender As Object, e As EventArgs) Handles TOOLWHATSAPP.Click
        Try
            ...
            DT = OBJCMN.Execute_Any_String("UPDATE GREYSALERETURNCHALLAN SET GSRCH_SENDWHATSAPP = 1 WHERE GSRCH_NO = " & TEMPSRCHNO & " AND GSRCH_YEARID = " & YearId, "", "")
    ...
    Async Sub SENDWHATSAPP(SRNO As Integer)
        Try
            ...
            OBJSR.FRMSTRING = "GREYSALERETURNCHALLAN"
            OBJSR.DIRECTMAIL = True
            OBJSR.WHERECLAUSE = "{GREYSALERETURNCHALLAN.GSRCH_NO}=" & Val(SRNO) & " and {GREYSALERETURNCHALLAN.GSRCH_yearid}=" & YearId
            OBJSR.SALRETNO = SRNO
            OBJSR.NOOFCOPIES = 1
            OBJSR.Show()
            OBJSR.Close()
            ...
            OBJWHATSAPP.PATH.Add(Application.StartupPath & "\GREYSALRET_" & Val(SRNO) & ".pdf")
