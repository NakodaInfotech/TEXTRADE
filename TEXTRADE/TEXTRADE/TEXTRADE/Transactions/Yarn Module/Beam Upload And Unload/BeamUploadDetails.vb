...
Public Class BeamUploadDetails
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal GREYNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJBEAMREC As New BeamUpload
    ...
    Private Sub BeamUploadDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BeamUploadDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Sub fillgrid()
        ...
        Try
            ...
            Dim dt As DataTable = objclsCMST.search("BEAMUPLOAD.BEAMUPLOAD_NO AS GREYNO, BEAMUPLOAD.BEAMUPLOAD_DATE AS DATE, GODOWNMASTER.GODOWN_name AS GODOWN, LEDGERS.Acc_cmpname AS NAME, BEAMUPLOAD.BEAMUPLOAD_LOOMNO AS LOOMNO, BEAMUPLOAD.BEAMUPLOAD_BEAMNO AS BEAMNO, ISNULL(BEAMUPLOAD.BEAMUPLOAD_REMARKS, '') AS REMARKS, BEAMUPLOAD.BEAMUPLOAD_DONE AS DONE,  ISNULL(BEAMUPLOAD.BEAMUPLOAD_BEAMNAME, '') AS BEAMNAME  ", "", "BEAMUPLOAD INNER JOIN GODOWNMASTER ON BEAMUPLOAD.BEAMUPLOAD_GODOWNID = GODOWNMASTER.GODOWN_id AND BEAMUPLOAD.BEAMUPLOAD_yearid = GODOWNMASTER.GODOWN_yearid INNER JOIN LEDGERS ON BEAMUPLOAD.BEAMUPLOAD_LEDGERID = LEDGERS.Acc_id  ", " AND BEAMUPLOAD.BEAMUPLOAD_yearid =" & YearId & " ORDER BY BEAMUPLOAD.BEAMUPLOAD_NO ")
