    ...
    Private Sub cmdok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            For i As Integer = 0 To gridbill.RowCount - 1
                Dim dtrow As DataRow = gridbill.GetDataRow(i)
                If Convert.ToBoolean(dtrow("CHK")) = True Then
                    DT.Rows.Add(dtrow("NAME"), dtrow("JOBNO"), dtrow("JOBSRNO"), dtrow("FROMTYPE"), Val(dtrow("REED")), Val(dtrow("REEDSPACE")), Val(dtrow("PICS")), dtrow("REFNO"), dtrow("ITEMNAME"), dtrow("ENDS"), Val(dtrow("JOBMTRS")), dtrow("DESCRIPTION"), dtrow("DESIGNNO"), dtrow("COLOR"), dtrow("PARTYNAME"))
                End If
            Next
            Me.Close()
        Catch ex As Exception
