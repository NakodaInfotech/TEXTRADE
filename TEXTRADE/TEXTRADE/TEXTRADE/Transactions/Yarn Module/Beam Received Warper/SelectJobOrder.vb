...
Public Class SelectJobOrder
    ...
    Sub FILLGRID(ByVal WHERE As String)
        Try
            ...
            If ClientName = "SWPL" And FRMSTRING = "GRERECD" Then
                If SIZERNAME <> "" Then WHERE = WHERE & " AND WEAVERLEDGERS.ACC_CMPNAME = '" & SIZERNAME & "'"
            Else
