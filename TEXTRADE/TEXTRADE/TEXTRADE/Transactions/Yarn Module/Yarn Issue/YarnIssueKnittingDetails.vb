...
Public Class YarnIssueKnittingDetails
    ...
    Private Sub GRNDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            fillgrid(" and dbo.YARNISSUEKNITTING.YARN_yearid=" & YearId & " order by dbo.YARNISSUEKNITTING.YARN_no ")
    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            Dim OBJDEPT As New ClsYarnIssueKnitting
    ...
    Sub showform(ByVal editval As Boolean, ByVal SRNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objGRN As New YarnIssueKnitting
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Yarn Issue Knitting Details.XLS"
            Dim opti As New DevExpress.XtraPrinting.XlsExportOptions
            opti.ShowGridLines = True
            opti.SheetName = "Yarn Issue Knitting Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Yarn Issue Knitting Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
