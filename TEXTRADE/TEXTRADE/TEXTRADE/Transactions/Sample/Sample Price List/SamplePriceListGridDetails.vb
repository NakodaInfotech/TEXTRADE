...
Public Class SamplePriceListGridDetails
    ...
    Private Sub SamplePriceListGridDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Sub fillgrid(ByVal TEMPCONDITION)
        Try
            Dim OBJSMP As New ClsSamplePriceList
