...
Public Class SampleBookletCreationDetails
    ...
    Sub fillgrid()
        Try
            Dim OBJSMP As New ClsSampleBookletCreation
            OBJSMP.alParaval.Add(0)
            OBJSMP.alParaval.Add(CmpId)
            OBJSMP.alParaval.Add(YearId)
            Dim DT As DataTable = OBJSMP.SELECTSM()
    ...
    Sub showform(ByVal editval As Boolean, ByVal SMNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objPO As New SampleBookletCreation
    ...
    Private Sub gridpayment_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gridbill.DoubleClick
        Try
            showform(True, gridbill.GetFocusedRowCellValue("SMNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
