...
Public Class SampleStockTakingDetails
    ...
    Sub fillgrid()
        Try
            ...
            Dim dt As DataTable = OBJSTOCK.SELECTSAMPLESTOCKTAKING(0, CmpId, YearId)
    ...
    Sub showform(ByVal editval As Boolean, ByVal STOCKNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objSTOCK As New SampleStockTaking
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Sample Stock Taking Details.XLS"
            Dim opti As New DevExpress.XtraPrinting.XlsExportOptions
            opti.ShowGridLines = True
            opti.SheetName = "Sample Stock Taking Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Sample Stock Taking Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
