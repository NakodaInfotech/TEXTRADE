...
Public Class InterGodownTransferSampleDetails
    ...
    Sub fillgrid()
        Try
            Dim OBJGODOWN As New ClsInterGodownTransferSample
            OBJGODOWN.alParaval.Add(0)
    ...
    Sub showform(ByVal editval As Boolean, ByVal TEMPGODOWNNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objgdn As New InterGodownTransferSample
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Sample Transfer Details.XLS"
            Dim opti As New DevExpress.XtraPrinting.XlsExportOptions
            opti.ShowGridLines = True
            opti.SheetName = "Sample Transfer Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Sample Transfer Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
            MsgBox("Sample Transfer Details Excel File is Open, Please Close the File first then try to Export", MsgBoxStyle.Critical)
        End Try
    End Sub
