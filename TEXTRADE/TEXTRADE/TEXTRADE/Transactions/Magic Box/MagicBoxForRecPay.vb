    ...
    Function ERRORVALID() As Boolean
        Try
            ...
            If CMBACCNAME.Text.Trim = "" Then
                EP.SetError(CMBACCNAME, "Select Bank")
                BLN = False
            End If

            If CMBNAME.Text.Trim = "" Then
                EP.SetError(CMBNAME, "Select Buyer Name")
                BLN = False
            End If

            If CMBSELLERNAME.Text.Trim = "" Then
                EP.SetError(CMBSELLERNAME, "Select Seller Name")
                BLN = False
            End If

            If Val(TXTCHQAMT.Text.Trim) = 0 Then
                EP.SetError(TXTCHQAMT, "Enter Chq Amount")
                BLN = False
            End If

            If CMBPAYTYPE.Text.Trim = "" Then
                EP.SetError(CMBPAYTYPE, "Select Type")
                BLN = False
            End If

            If Val(TXTREMAINING.Text.Trim) <> 0 Then
                EP.SetError(TXTREMAINING, "Enter Proper Amount")
                BLN = False
            End If
