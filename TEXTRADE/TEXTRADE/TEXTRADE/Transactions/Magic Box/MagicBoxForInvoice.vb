    ...
    Private Sub CMDSELECTPO_Click(sender As Object, e As EventArgs) Handles CMDSELECTPO.Click
        Try
            ...
            If ClientName = "ABHEE" And EDIT = False And Val(TXTPONO.Text.Trim) > 0 Then
                ...
                DT = OBJCMN.SEARCH(" ISNULL(PO_DISPER, 0) AS DISCPER, 0 AS CDPER, 0 AS RATEDIFF, 0 AS AGENTCOMM, ISNULL(PO_CRDAYS,0) AS CRDAYS", "", " ALLPURCHASEORDER ", " and ALLPURCHASEORDER.PO_NO IN (" & TXTPONO.Text.Trim & ") and ALLPURCHASEORDER.PO_YEARid = " & YearId)
