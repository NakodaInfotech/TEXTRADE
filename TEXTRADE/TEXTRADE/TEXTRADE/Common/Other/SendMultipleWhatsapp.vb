        ...
        Try
            ...
            If TXTPARTYNO.Text.Trim = "" Then
                ...
                For I As Integer = 0 To gridbill.RowCount - 1
                    ...
                    strArray = Split(DTROW("PARTYWHATSAPP"), ";")

                    For J As Integer = 0 To strArray.Count - 1
                        If DTROW("PARTYWHATSAPP") <> "" And RBAGENT.Checked = False Then
                            RESPONSE = Await SENDWHATSAPPATTACHMENT("91" & strArray(J), DTROW("ATTACHMENT"), DTROW("FILENAME"))
                    ...
                    strArray = Split(DTROW("AGENTWHATSAPP"), ";")
                    For k As Integer = 0 To strArray.Count - 1
                        If DTROW("AGENTWHATSAPP") <> "" And RBPARTY.Checked = False Then
                            RESPONSE = Await SENDWHATSAPPATTACHMENT("91" & strArray(k), DTROW("ATTACHMENT"), DTROW("FILENAME"))
                            ERRORMESSAGE(DTROW("AGENTWHATSAPP"))
                        End If
                    Next
