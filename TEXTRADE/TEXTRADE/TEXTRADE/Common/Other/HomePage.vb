    ...
    Sub FILLMONTHLYSALE()
        Try
            ...
            If RBPURCHASE.Checked = True Then
                DT = OBJCMN.SEARCH(" UPPER(DATENAME(MONTH, BILL_DATE)) AS [MONTHNAME], SUM(BILL_SUBTOTAL) AS TAXABLEAMT, SUM(BILL_GRANDTOTAL) AS GRANDTOTAL, ROUND(SUM(BILL_GRANDTOTAL)/GTOTAL* 100,2) AS PER  ", "", " PURCHASEMASTER CROSS APPLY (SELECT TOP 1 SUM(BILL_GRANDTOTAL) AS GTOTAL FROM PURCHASEMASTER AS GINV WHERE PURCHASEMASTER.BILL_YEARID = GINV.BILL_YEARID ) AS GINV  ", " AND BILL_YEARID = " & YearId & " GROUP BY DATENAME(MONTH, BILL_DATE), GTOTAL ORDER BY (CASE WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'APRIL' THEN 1 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'MAY' THEN 2 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'JUNE' THEN 3 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'JULY' THEN 4 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'AUGUST' THEN 5 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'SEPTEMBER' THEN 6 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'OCTOBER' THEN 7 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'NOVEMBER' THEN 8 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'DECEMBER' THEN 9 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'JANUARY' THEN 10 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'FEBRUARY' THEN 11 WHEN UPPER(DATENAME(MONTH, BILL_DATE)) = 'MARCH' THEN 12 ELSE 13 END)")
