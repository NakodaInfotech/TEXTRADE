...
Public Class MDIMain
    ...
    Private Sub MDIMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If ClientName = "YASHVI" Or ClientName = "NAKODAINFOTECH" Or ClientName = "AVIS" Or ClientName = "MILUXE" Or ClientName = "ABHEE" Or ClientName = "SWPL" Or ClientName = "MMC" Then
                Timer1.Enabled = True
            ...
            If DT1.Rows.Count > 0 Then
                ...
                SHOWOVERDUE = DT1.Rows(0).Item("SHOWOVERDUE")
                SHOWPERFORMANCE = DT1.Rows(0).Item("SHOWPERFORMANCE")
            ...
            For Each DTROW As DataRow In USERRIGHTS.Rows
                ...
                ElseIf DTROW(0).ToString = "YARN RECD" Then
                    If DTROW(1).ToString = True Then
                        ...
                        YARNLOAN_MASTER.Enabled = True
                        YARNLOANADD.Enabled = True
                    Else
                ...
                ElseIf DTROW(0).ToString = "YARN JOBORDER" Then
                    If DTROW(1).ToString = True Then
                        YARNJOBORDER_MASTER.Enabled = True
                        YARNJOBORDERADD.Enabled = True
                        YARNJOBORDERCLOSE.Enabled = True
                    Else
                        YARNJOBORDERADD.Enabled = False
                    End If
                    If (DTROW(2) = True) Or (DTROW(3) = True) Or (DTROW(4) = True) Then
                        YARNJOBORDER_MASTER.Enabled = True
                        YARNJOBORDEREDIT.Enabled = True
                        YARNJOBORDERCLOSE.Enabled = True
                    Else
                        YARNJOBORDEREDIT.Enabled = False
                    End If


                ElseIf DTROW(0).ToString = "YARNINTERGODOWN" Then
                    If DTROW(1).ToString = True Then
...
SKIPLINE:
    ...
    Private Sub STORELOAN_EDIT_Click(sender As Object, e As EventArgs) Handles STORELOAN_EDIT.Click
        Try
            Dim OBJMASTERTRANSFER As New StoresLoanDetails
            OBJMASTERTRANSFER.MdiParent = Me
            OBJMASTERTRANSFER.Show()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub YARNSTOCKADJUSTMENTADD_Click(sender As Object, e As EventArgs) Handles YARNSTOCKADJUSTMENTADD.Click
        Try
            Dim OBJYARN As New YarnStockReco
            OBJYARN.MdiParent = Me
            OBJYARN.Show()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub YARNSTOCKADJUSTMENTEDIT_Click(sender As Object, e As EventArgs) Handles YARNSTOCKADJUSTMENTEDIT.Click
        Try
            Dim OBJYARN As New YarnStockRecoDetails
            OBJYARN.MdiParent = Me
            OBJYARN.Show()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub YARNJOBORDERCLOSE_Click(sender As Object, e As EventArgs) Handles YARNJOBORDERCLOSE.Click
        Try
            Dim OBJYARNJO As New YarnJobOrderClose
    ...
    Private Sub YARNLOOMEFFICIENCY_EDIT_Click(sender As Object, e As EventArgs) Handles YARNLOOMEFFICIENCY_EDIT.Click
        Try
            Dim OBJYARNJO As New YarnLoomEfficiencyDetails
            OBJYARNJO.MdiParent = Me
            OBJYARNJO.Show()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub OPSTOCKGREYINHOUSE_Click(sender As Object, e As EventArgs) Handles OPSTOCKGREYINHOUSE.Click
        Try
            Dim OBJ As New OpeningStockGrey
            OBJ.FRMSTRING = "INHOUSE"
            OBJ.MdiParent = Me
            OBJ.Show()
        Catch ex As Exception
    ...
    Private Sub OPSTOCKGREYATPARTY_Click(sender As Object, e As EventArgs) Handles OPSTOCKGREYATPARTY.Click
        Try
            Dim OBJ As New OpeningStockGrey
            OBJ.FRMSTRING = "JOBBERSTOCK"
            OBJ.MdiParent = Me
    ...
    Private Sub UPLOADSTOCK_FINISHED_Click(sender As Object, e As EventArgs) Handles UPLOADSTOCK_FINISHED.Click
        UPLOADFINISHSTOCK("INHOUSE")
    End Sub

    Private Sub UPLOADSTOCK_JOBBER_Click(sender As Object, e As EventArgs) Handles UPLOADSTOCK_JOBBER.Click
        UPLOADFINISHSTOCK("JOBBERSTOCK")
    End Sub

    Sub UPLOADFINISHSTOCK(UPLOADTYPE As String)
        Try
            ...
            Try
                ...
                For I As Integer = FROMROWNO To TOROWNO
                    ...
                    ALPARAVAL.Add(AccFrom.Date)
                    ALPARAVAL.Add(UPLOADTYPE)           'INHOUSE | JOBBERSTOCK
...
SKIPLINE:
    ...
    Private Sub UPLOADSTOCK_GREY_Click(sender As Object, e As EventArgs) Handles UPLOADSTOCK_GREY.Click
...
SKIPLINE:
    ...
    Private Sub GREYSTOCKADJUSTMENT_ADD_Click(sender As Object, e As EventArgs) Handles GREYSTOCKADJUSTMENT_ADD.Click
        Try
    ...
    Private Sub COMPLAINTSOLVED_EDIT_Click(sender As Object, e As EventArgs) Handles COMPLAINTSOLVED_EDIT.Click
        Try
