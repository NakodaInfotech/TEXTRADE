...
Public Class StoreConsumptionReport
    Dim fromD
    Dim toD
    ...
    Private Sub StoreConsumptionReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            fillcmb()
        Catch ex As Exception
            Throw ex
    ...
    Sub fillcmb()
        Try
            ...
            If CMBDEPARTMENT.Text.Trim = "" Then fillGODOWN(CMBDEPARTMENT, False)
    ...
    Private Sub StoreConsumptionReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
