...
Public Class StockFilter
    ...
    Private Sub cmdshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            ...
            If RBBARCODEBALESTOCK.Checked = True Or RBBARCODESTOCKDTLS.Checked = True Or RBITEMDESIGNSHADESEMISMALLSUMM.Checked = True Or RBITEMDESIGNSHADESMALLSUMM.Checked = True Or RBITEMDESIGNSHADESMALLNOUNITSUMM.Checked = True Or RBCATEGORYITEMDESIGNSHADESMALLNOUNITSUMM.Checked = True Or RBDESIGNNOTSENT.Checked = True Or RDBBALECOUNT.Checked = True Or (ALLOWBARCODEPRINT = True And RBITEMDESIGNSHADESUMM.Checked = True) Or (ALLOWBARCODEPRINT = True And (RBGODOWNWISESUMM.Checked = True Or RDBBARCODESTOCKSUMMIMG.Checked = True)) Then
