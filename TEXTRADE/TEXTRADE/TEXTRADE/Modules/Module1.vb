...
Module Module1
    ...
    'Public DatabaseName As String = "TEXTRADE"          'Used for Servername for reports'
    ...
    Public SHOWSIGNONINVOICE As Boolean = False
    ...
    Public MANUALRECPACKQTY As Boolean = False
    Public PCSTOPCSDETAILS As Boolean = False
    Public GODNAME As String = ""
    Public ALLOWMANUALJONO As Boolean
    Public CHALLANCUTWHEN1 As Boolean
    Public CHALLANCUT As Boolean
    ...
    Public HIDEAGENCY As Boolean = True
    Public HIDEGREY As Boolean = False
    ...
    Public HIDEPOSTER As Boolean = True
