    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            ...
            ElseIf RBGSTR1.Checked = True Then
                If MsgBox("Wish To Mail Directly?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
                    ...
                    If chkdate.CheckState = CheckState.Checked Then
                        ...
                        OBJRPTHSN.GSTHSN_EXCEL(CmpId, YearId, Convert.ToDateTime(dtfrom.Text), Convert.ToDateTime(dtto.Text), INVOICESCREENTYPE, ClientName, CMBREGISTER.Text.Trim)
                    ...
                    Else
                        ...
                        OBJRPTHSN.GSTHSN_EXCEL(CmpId, YearId, AccFrom, AccTo, INVOICESCREENTYPE, ClientName, CMBREGISTER.Text.Trim)
            ...
            ElseIf RBGSTR1GRID.Checked = True Then
                ...
                If chkdate.CheckState = True Then
