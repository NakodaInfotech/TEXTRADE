...
Public Class MDIMain
    ...
    Private Sub MDIMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If ClientName = "YASHVI" Or ClientName = "NAKODAINFOTECH" Then
                Timer1.Enabled = True
    ...
    Private Sub GRN_TOOL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GRNGREY_TOOL.Click
        Try
            Dim OBJGRN As New GRN
            OBJGRN.MdiParent = Me
            If ClientName = "CC" Or ClientName = "C3" Or ClientName = "KREEVE" Or ClientName = "PURPLE" Or ClientName = "INDRANI" Or ClientName = "GELATO" Or ClientName = "NVAHAN" Or ClientName = "SAKARIA" Or ClientName = "MANIBHADRA" Or ClientName = "TCOT" Or ClientName = "MOMAI" Or ClientName = "MNIKHIL" Or ClientName = "HRITI" Or ClientName = "MVIKASKUMAR" Or ClientName = "KRFABRICS" Or ClientName = "AMAN" Or ClientName = "BALAJI" Or ClientName = "CHINTAN" Or ClientName = "SSC" Or ClientName = "SST" Or ClientName = "MBB" Or ClientName = "VINIT" Or ClientName = "MANISH" Or ClientName = "TINUMINU" Or ClientName = "RADHA" Or ClientName = "VINTAGEINDIA" Or HIDEGREY = True Then OBJGRN.FRMSTRING = "GRN FANCY" Else OBJGRN.FRMSTRING = "GRNJOB"
            OBJGRN.Show()
        Catch ex As Exception
            Throw ex
        End Try
...
SKIPLINE:
    ...
    Private Sub MDIMain_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
            ...
            If ClientName = "MANIBHADRA" Or ClientName = "GELATO" Or ClientName = "INDRANI" Or ClientName = "MNIKHIL" Or ClientName = "HRITI" Or ClientName = "KREEVE" Or ClientName = "MVIKASKUMAR" Or ClientName = "KRFABRICS" Or ClientName = "AMAN" Or ClientName = "BALAJI" Or ClientName = "CHINTAN" Or ClientName = "SSC" Or ClientName = "SST" Or ClientName = "MBB" Or ClientName = "VINIT" Or ClientName = "MANISH" Or ClientName = "TINUMINU" Or ClientName = "RADHA" Or ClientName = "VINTAGEINDIA" Or HIDEGREY = True Then GRNGREY_TOOL.Text = "Finish Inward"
            If ClientName = "MJFABRIC" Then GDN_TOOL.Text = "Packing Slip"
            ...
            If ClientName = "VINTAGEINDIA" Then
                GODOWNCHANGEMASTER.Enabled = True
            Else
                GODOWNCHANGEMASTER.Enabled = False
            End If
        Catch ex As Exception
            Throw ex
        End Try
...
SKIPLINE:
    ...
    Private Sub GodownChangeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GODOWNCHANGEMASTER.Click
        Try
    ...
    Private Sub CoverNoteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CoverNoteToolStripMenuItem.Click
        Try
