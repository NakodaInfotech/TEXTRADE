...
SELECT @CMPNAME = 'SUPRIYA SILK INDUSTRIES'
...
SET @SUBJECT = 'SSI-PENDING CHALLAN FOR INVOICE ' + CAST(DAY(GETDATE()) AS VARCHAR(2)) + '-' + CAST(MONTH( GETDATE()) AS VARCHAR(2)) + '-' + CAST(YEAR( GETDATE()) AS VARCHAR(4))
