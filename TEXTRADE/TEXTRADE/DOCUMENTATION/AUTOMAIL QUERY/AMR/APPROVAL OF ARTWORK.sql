...
WHERE ISNULL(LEDGERS.Acc_email,'') <> '' AND ITEM_SHADEAPPDATE ='/  /' AND LEDGERS.Acc_yearid = @YEARID 
...
open CUR_MAINNAME
	...
	while @@Fetch_STATUS = 0
		begin
			...
			WHERE ISNULL(LEDGERS.Acc_email,'') <> '' AND ITEM_SHADEAPPDATE ='/  /' AND  LEDGERS.Acc_id = @ACCID
