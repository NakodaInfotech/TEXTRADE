DECLARE @SUBJECT VARCHAR(100), @ENTRYBODY VARCHAR(MAX), @TOTALTAXABLE DECIMAL(18,2), @TOTALMTRS DECIMAL(18,2), @TOTALCANCELAMT DECIMAL(18,2), @TOTALCANCELMTRS DECIMAL(18,2)
SET @SUBJECT = 'MONTHLY ORDER CANCELLATION REPORT FOR ' + UPPER(DATENAME(MONTH,  DATEADD(MONTH,-1, GETDATE())  ))
